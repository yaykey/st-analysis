...
public class GStockDayManager extends
	 ...
	 */
	private static final Log logger = LogFactory.getLog(GStockDayManager.class);
	...
	public List<List<GStockDay>> selectRangePer (Integer stockCode, int sec, Date startDateId, Date endDateId, String type) {
		
		List<String> timeIds = DateUtil.getRangeTimes(sec);
		
		return this.selectRangePer(stockCode, timeIds, startDateId, endDateId, type);
	}
	
	public List<List<GStockDay>> selectRangePer (Integer stockCode, List<String> timeIds, Date startDateId, Date endDateId, String type) {
	...
	public List<GStockDay> selectListByExample (GStockDayExample example , Map<String, Integer> order) {
	...
	private void appendOrderBy (GStockDayExample example , Map<String, Integer> order) {
		if (order != null) {
			String orderByStr = "";
			...
			if (order.get("priceChanges") != null && order.get("priceChanges") != 0) {
	...
	public void selectPer(Date startDate, Date endDate, Double startPer, Double endPer) {
		GStockDayExample example = new GStockDayExample();
