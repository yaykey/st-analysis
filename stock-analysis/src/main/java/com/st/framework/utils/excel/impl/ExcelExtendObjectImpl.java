...
public class ExcelExtendObjectImpl implements ExcelObject {
	
	private static final Logger log = LoggerFactory.getLogger(ExcelExtendObjectImpl.class);
	...
	public ExcelExtendObjectImpl(CellLocation location, List<FieldInfo> fields, int type){
		super();
