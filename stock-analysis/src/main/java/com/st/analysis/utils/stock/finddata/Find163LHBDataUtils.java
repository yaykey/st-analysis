...
public class Find163LHBDataUtils extends BaseDBUtils {
	...
	public static void findLhbData (String stockCode) {
		Document doc = null;
	...
	private static List<GLHBTop5> parseTop5List (Element top5, String stockCode, Date dateId) {
	...
	private static GLHBTop5 parseTop5 (Element top5tr, String stockCode, Date dateId, String type) {
	...
	private static GLHBReport parseReport (Element rpt, String stockCode) {
		...
		
		{
			...
			try {
				report.setDateId(Global.DF_DAY.parse(dateId));
	...
	public static void main (String [] args) {
		for (int i=300004; i<300449; i++) {
			long d = System.currentTimeMillis();
			findLhbData("" + i);
			System.out.println(i + "\t->耗时:" + (System.currentTimeMillis() - d));
		}
