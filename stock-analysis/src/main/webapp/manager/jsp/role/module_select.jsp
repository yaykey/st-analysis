...
<script>
		...
		$(function(){
			...
			userTreeInit()
			$('#btn_add').bind('click',function() {insertAllSelected(userSelectForm.lstSelected,"true");})
		...
		function userTreeInit(){
			jQuery.ajax({
				type : "POST",
				url : '${base}/manager/role/authorise/getAllModule.feinno?roleId=${requestScope.roleId}',
				dataType : 'text',
				data : {
			...
			<tr >
				...
				<td  class="td-left"  style="vertical-align:top">
					...
					<select name="lstSelected" multiple id="lstSelected" style="width:215px;height:373px;margin-top: 9px">
						<c:forEach  var="module" items="${requestScope.moduleList}">
