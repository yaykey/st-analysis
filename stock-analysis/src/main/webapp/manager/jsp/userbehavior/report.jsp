...
<ul class="v4_btn clearfix" id="report_static">
 ...
 <li><a href="javascript:void(-1);" id="classid_${reportClass.classId}"  classtype="${reportClass.classType}" classid="${reportClass.classId}" title="${reportClass.className}" class="a4 sty1" onclick="funStype('${reportClass.classId}')">
 	<c:choose>  
...
searchRptType();
funStype($("#report_static").find("li").find("a").attr("classid"));
</script>