...
<html>
	...
	<body>
		<form action="${baseManager}/selfinfo/modifypwd.${actionExt}" method="post" name="signupform" id="signupform">
		        	...
		        	<li>
			           	...
			           	<p>
		          			...
		          			<span class="info-content">
		          				<input type="password" readonly="readonly" id="password" name="password" style="color: #CDCDCD;" value="${empty requestScope.pwd ? '': requestScope.pwd}"/>
		          			</span>
		       			</p>
		       			<p>
