...
<html>
	...
	<frameset >
		<frameset id="widgetMain_frm" name="widgetMain_frm" cols="125,10,500" framespacing="0"
			...
			<frame src="${baseManager }/jsp/widget/frame/ztree_widget.jsp" name="menuTreeFrame" scrolling="NO" >
			<frame src="${baseManager }/jsp/widget/frame/switch.jsp" name="switchFrame" scrolling="NO" >
