...
AmCharts.getIEVersion = function() {
	...
	if ("Microsoft Internet Explorer" == navigator.appName) {
		...
		"Netscape" == navigator.appName
				&& (b = navigator.userAgent, c = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/, null != c
						.exec(b)
...
AmCharts.applyLang = function(a, b) {
	...
	c
			&& (c = c[a])
			&& (AmCharts.lang = c, c.monthNames
					&& (b.dayNames = c.dayNames, b.shortDayNames = c.shortDayNames, b.monthNames = c.monthNames, b.shortMonthNames = c.shortMonthNames))
};
...
document.attachEvent
		&& (AmCharts.isNN = !1, AmCharts.isIE = !0, AmCharts.isModern
...
AmCharts.handleWheel = function(a) {
	for (var b = AmCharts.charts, c = 0; c < b.length; c++) {
		var d = b[c];
		if (d && d.mouseIsOver) {
			d.mouseWheelScrollEnabled || d.mouseWheelZoomEnabled ? d
					.handleWheel(a) : a.stopPropagation && a.stopPropagation();
			break
		}
	}
};
...
AmCharts.handleLoad = function() {
	...
	for (var a = AmCharts.onReadyArray, b = 0; b < a.length; b++) {
		var c = a[b];
		isNaN(AmCharts.processDelay) ? c() : setTimeout(c,
				AmCharts.processDelay * b)
	}
};
...
AmCharts.callInitHandler = function(a) {
	...
	if (AmCharts.initHandlers)
		for (var c = 0; c < b.length; c++) {
			var d = b[c];
			d.types ? -1 != d.types.indexOf(a.type) && d.method(a) : d
					.method(a)
		}
};
...
AmCharts.isNN
		&& (document
				...
				.addEventListener("load", AmCharts.handleLoad, !0), window
				.addEventListener("DOMMouseScroll", AmCharts.handleWheel, !0), document
				.addEventListener("mousewheel", AmCharts.handleWheel, !0));
AmCharts.isIE
...
AmCharts.clear = function() {
	...
	AmCharts.isNN
			&& (document.removeEventListener("mousemove",
					...
					.removeEventListener("load", AmCharts.handleLoad, !0), window
					.removeEventListener("DOMMouseScroll",
							AmCharts.handleWheel, !0), document
					.removeEventListener("mousewheel", AmCharts.handleWheel, !0));
	AmCharts.isIE
	...
	if (l) {
		...
		if (n.width > h) {
			...
			if (isNaN(q)) {
				if (0 == k)
					for (p = 1; p < n; p++)
						q = Math.round(b.length / n * p), b = b.substr(0, q)
								+ m + b.substr(q);
	...
	if (a)
		if ("_self" != b && b)
			if ("_top" == b && window.top)
				...
				c ? c.src = a : (c = AmCharts.windows[b])
...
AmCharts.toCoordinate = function(a, b, c) {
	var d;
	void 0 !== a
			&& (a = String(a), c && c < b && (b = c), d = Number(a), -1 != a
					.indexOf("!")
					&& (d = b - Number(a.substr(1))), -1 != a.indexOf("%")
...
AmCharts.formatDuration = function(a, b, c, d, e, f) {
	...
	if (a >= g[b].contains) {
		...
		"ss" == b
				&& (k = AmCharts.formatNumber(k, f), 1 == k.split(h)[0].length
						&& (k = "0" + k));
	...
	"ss" == b
			&& (a = AmCharts.formatNumber(a, f), 1 == a.split(h)[0].length
					&& (a = "0" + a));
...
AmCharts.addZeroes = function(a, b, c) {
	...
	return a[1].length < c ? (a[1] += "0", AmCharts.addZeroes(a[0] + b + a[1],
			b, c)) : void 0 !== a[1] ? a[0] + b + a[1] : a[0]
};
...
AmCharts.isInRectangle = function(a, b, c) {
	return a >= c.x - 5 && a <= c.x + c.width + 5 && b >= c.y - 5
			&& b <= c.y + c.height + 5 ? !0 : !1
};
...
AmCharts.formatValue = function(a, b, c, d, e, f, g, h) {
	if (b) {
		...
		for (k = 0; k < c.length; k++) {
			var l = c[k], m = b[l];
			void 0 !== m
					&& (m = f ? AmCharts.addPrefix(m, h, g, d) : AmCharts
							.formatNumber(m, d), a = a.replace(new RegExp(
									"\\[\\[" + e + "" + l + "\\]\\]", "g"), m))
		}
	}
	return a
...
AmCharts.addPrefix = function(a, b, c, d, e) {
	...
	if (1 < a)
		for (h = b.length - 1; -1 < h; h--) {
			if (a >= b[h].number
					&& (k = a / b[h].number, l = Number(d.precision), 1 > l
							&& (l = 1), c = AmCharts.roundTo(k, l), l = AmCharts
							.formatNumber(c, {
										precision : -1,
...
AmCharts.copyProperties = function(a, b) {
	for (var c in a)
		a.hasOwnProperty(c) && "events" != c && void 0 !== a[c]
				&& "function" != typeof a[c] && "cname" != c && (b[c] = a[c])
};
			...
			if ("[object Array]" === Object.prototype.toString.call(a))
				...
				try {
					for (c in a)
						a[c]
								&& ("object" == typeof a[c]
										&& AmCharts.deleteObject(a[c], b - 1), "function" != typeof a[c]
										&& (a[c] = null))
				} catch (d) {
				}
	}
...
AmCharts.bounce = function(a, b, c, d, e) {
	return (b /= e) < 1 / 2.75 ? 7.5625 * d * b * b + c : b < 2 / 2.75 ? d
			* (7.5625 * (b -= 1.5 / 2.75) * b + .75) + c : b < 2.5 / 2.75 ? d
...
AmCharts.easeOutElastic = function(a, b, c, d, e) {
	...
	g < Math.abs(d) ? (g = d, a = f / 4) : a = f / (2 * Math.PI)
			* Math.asin(d / g);
	return g * Math.pow(2, -10 * b) * Math.sin(2 * (b * e - a) * Math.PI / f)
			+ d + c
};
AmCharts.AxisBase = AmCharts.Class({
	...
	draw : function() {
		...
		this.autoGridCount
				? ("V" == this.orientation
						? (a = this.height / this.minVerticalGap, 3 > a
								&& (a = 3))
						: a = this.width / this.minHorizontalGap, this.gridCountR = Math
						.max(a, 1))
	...
	addTitle : function() {
		...
		if (a) {
			...
			this.titleLabel = AmCharts.text(b.container, a, c, b.fontFamily, d,
					this.titleAlign, this.titleBold)
		}
	},
	positionTitle : function() {
		...
		if (a) {
			...
			var g = e.width, e = e.height, h = this.viW, k = this.viH, l = 0, m = a
					.getBBox().height
					/ 2, n = this.inside, p = this.titleAlign;
			switch (this.position) {
				...
				case "left" :
					...
					break;
				case "right" :
					b = d + g + 10 + m - 3, n && (b += 7), c = "left" == p ? k
							+ 2 : "right" == p ? -2 : k / 2, l = -90
			}
			this.marginsChanged
	...
	handleGuideOver : function(a) {
		...
		var b = a.graphics.getBBox(), c = b.x + b.width / 2, b = b.y + b.height
				/ 2, d = a.fillColor;
...
AmCharts.ValueAxis = AmCharts.Class({
		...
		this.synchronizationMultiplier && this.synchronizeWith
				? (AmCharts.isString(this.synchronizeWith)
						&& (this.synchronizeWith = a
								.getValueAxisById(this.synchronizeWith)), this.synchronizeWith
	...
	draw : function() {
		...
		if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs
			...
			var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, n = 1, p = 0, q = Math
					.round((this.max - this.min) / this.step)
					+ 1, r;
			!0 === d
					? (r = Math.log(this.max) * Math.LOG10E
							- Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth
							/ r, r > this.logGridLimit
							&& (q = Math.ceil(Math.log(this.max) * Math.LOG10E)
									+ 1, p = Math.round(Math.log(this.minReal)
									* Math.LOG10E), q > this.gridCountR
									&& (n = Math.ceil(q / this.gridCountR))))
					: this.stepWidth = this.axisWidth / (this.max - this.min);
			var t = 0;
			1 > this.step && -1 < this.step
					&& (t = AmCharts.getDecimals(this.step));
			...
			if (0 < e) {
				...
				for (f = this.fillAlpha = 0; f < e; f++) {
					...
					isNaN(x.toValue)
							|| (F = this.getCoordinate(x.toValue), v = new this.axisItemRenderer(
									this, F, "", !0, NaN, NaN, x), this
									.pushAxisItem(v, B));
					var z = NaN;
					isNaN(x.value)
							|| (z = this.getCoordinate(x.value), v = new this.axisItemRenderer(
									this, z, x.label, !0, NaN, (F - z) / 2, x), this
									.pushAxisItem(v, B));
					isNaN(F - z)
							|| (v = new this.guideFillRenderer(this, z, F, x), this
									.pushAxisItem(v, B), v = v.graphics(), x.graphics = v, x.balloonText
									&& this.addEventListeners(v, x))
				}
				this.fillAlpha = u
			}
			this.exponential = !1;
			for (f = p; f < q; f += n)
				s = AmCharts.roundTo(this.step * f + this.min, t), -1 != String(s)
						.indexOf("e")
						&& (this.exponential = !0, String(s).split("e"));
			this.duration
					&& (this.maxInterval = AmCharts.getMaxInterval(this.max,
							this.duration));
			var t = this.step, I, s = this.minorGridAlpha;
			this.minorGridEnabled
					&& (I = this.getMinorGridStep(t, this.stepWidth * t));
			for (f = p; f < q; f += n)
				if (p = t * f + this.min, d
						&& this.max - this.min > 5 * this.min
						&& (p -= this.min), p = AmCharts.roundTo(p,
						this.maxDecCount + 1), !this.integersOnly
						|| Math.round(p) == p)
					if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
						!0 === d
								&& (0 === p && (p = this.minReal), r > this.logGridLimit
										&& (p = Math.pow(10, f)));
						...
						v = new this.axisItemRenderer(this, e, v, void 0,
								void 0, void 0, void 0, this.boldLabels);
						this.pushAxisItem(v);
							...
							"H" == this.orientation
									...
									: 0 <= e
											...
											&& (E = [0, x, x + g], H = [e, e,
													e + h]);
							E
									&& (e = AmCharts.fitToBounds(2
													* this.gridAlpha, 0, 1), e = AmCharts
											.line(a.container, E, H,
													this.gridColor, e, 1,
													this.dashLength), e
											.translate(v, u), this.grid0 = e, a.axesSet
											.push(e), e.toBack())
						}
						if (!isNaN(I) && 0 < s && f < q - 1) {
							...
							for (e = 1; e < t / I; e++)
								u = this.getCoordinate(p + I * e), u = new this.axisItemRenderer(
										this, u, "", !1, 0, 0, !1, !1, 0, !0), this
										.pushAxisItem(u);
							this.gridAlpha = v
						}
					}
		...
		r = this.labelsSet;
		this.positionTitle();
		"radar" != a.type ? (a = this.viX, I = this.viY, b.translate(a, I), r
				.translate(a, I)) : d.toFront();
		!this.visible || c ? (b.hide(), d.hide(), r.hide()) : (b.show(), d
				.show(), r.show());
	...
	formatValue : function(a, b, c) {
		...
		d
				? (valueText = -1 == String(a).indexOf("e") ? a
						.toExponential(15) : String(a), c = valueText
						.split("e"), b = Number(c[0]), c = Number(c[1]), b = AmCharts
						.roundTo(b, 14), 10 == b && (b = 1, c += 1), valueText = b
						+ "e" + c, 0 === a && (valueText = "0"), 1 == a
						&& (valueText = "1"))
				: (e
						&& (d = String(a).split("."), d[1]
								? (f.precision = d[1].length, 0 > c
										&& (f.precision = Math.abs(c)))
								: f.precision = -1), valueText = this.usePrefixes
						? AmCharts.addPrefix(a, g.prefixesOfBigNumbers,
								g.prefixesOfSmallNumbers, f, !b)
						: AmCharts.formatNumber(a, f, f.precision));
		this.duration
				&& (valueText = AmCharts.formatDuration(a, this.duration, "",
						this.durationUnits, this.maxInterval, f));
		this.recalculateToPercents ? valueText += "%" : (f = this.unit)
				&& (valueText = "left" == this.unitPosition
						? f + valueText
						: valueText + f);
		this.labelFunction
				&& (valueText = this.labelFunction(a, valueText, this)
						.toString());
		return valueText
	},
	...
	stackGraphs : function(a) {
		...
		for (k = this.start; k <= this.end; k++) {
			...
			for (n = 0; n < h.length; n++)
				if (m = h[n], m.hidden)
				...
				else if (l = m.type, m.chart == this.chart
						&& m.valueAxis == this && a == l && m.stackable)
					if (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g))
						...
						t = m.fillToGraph;
						q && t && (t = this.data[k].axes[this.id].graphs[t.id])
								&& (l.values.open = t.values.value);
						"regular" == b
								&& (q
										&& (isNaN(c[k])
												? (c[k] = g, l.values.close = g, l.values.open = this.baseValue)
												: (isNaN(g)
														? l.values.close = c[k]
														: l.values.close = g
																+ c[k], l.values.open = c[k], c[k] = l.values.close)), "column" == a
										&& (m.newStack
												&& (e[k] = NaN, d[k] = NaN), l.values.close = g, 0 > g
												? (l.values.close = g, isNaN(d[k])
														? l.values.open = p
														: (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close)
												: (l.values.close = g, isNaN(e[k])
														? l.values.open = p
			...
			for (n = 0; n < h.length; n++)
				(m = h[n], m.hidden)
						...
						: (l = m.type, m.chart == this.chart
								...
								&& a == l
								&& m.stackable
								&& (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g)
										|| (c = g / f[k] * 100, l.values.percents = c, l.values.total = f[k], m.newStack
												&& (e[k] = NaN, d[k] = NaN), "100%" == b
												&& (isNaN(d[k]) && (d[k] = 0), isNaN(e[k])
														&& (e[k] = 0), 0 > c
														? (l.values.close = AmCharts
																.fitToBounds(
																		c
																				+ d[k],
																		-100,
																		100), l.values.open = d[k], d[k] = l.values.close)
														: (l.values.close = AmCharts
																.fitToBounds(
																		c
																				+ e[k],
		...
		for (c = 0; c < b.length; c++) {
			...
			if (d.valueAxis == this) {
				...
				var f, g, h = this.end + 2, h = AmCharts.fitToBounds(this.end
								+ 1, 0, this.data.length - 1), k = this.start;
				0 < k && k--;
				var l;
				g = this.start;
				...
				if (!isNaN(a.startTime) && (l = a.categoryAxis)) {
					...
					var m = new Date(a.startTime + minDuration / 2), n = AmCharts
							.resetDateToMin(new Date(a.startTime), l.minPeriod)
							.getTime();
				...
				if (l = a.recalculateFromDate)
					a.dataDateFormat
							&& (l = AmCharts.stringToDate(l, a.dataDateFormat)), g = a
							.getClosestIndex(a.chartData, "time", l.getTime(),
									!0, 0, a.chartData.length), h = a.chartData.length
							- 1;
				for (l = g; l <= h
						&& (g = this.data[l].axes[this.id].graphs[d.id], f = g.values[e], isNaN(f)); l++);
				this.recBaseValue = f;
				for (e = k; e <= h; e++) {
	...
	getMinMax : function() {
		...
		a
				&& (0 < this.start && this.start--, this.end < this.data.length
						...
						&& this.end++);
		"serial" == b.type
				&& (!0 !== b.categoryAxis.parseDates || a || this.end < this.data.length
						- 1
						&& this.end++);
		...
		if (this.includeGuidesInMinMax && 0 < a)
			for (b = 0; b < a; b++)
				c = this.guides[b], c.toValue < this.min
						&& (this.min = c.toValue), c.value < this.min
						&& (this.min = c.value), c.toValue > this.max
						&& (this.max = c.toValue), c.value > this.max
						&& (this.max = c.value);
		...
		1 > c
				? (this.maxDecCount = Math.abs(Math.log(Math.abs(c))
	...
	zoomToValues : function(a, b) {
		...
		c.chart = this.chart;
		c.valueAxis = this;
		c.multiplier = this.axisWidth
				/ Math.abs(this.getCoordinate(b) - this.getCoordinate(a));
		c.position = "V" == this.orientation ? this.reversed ? this
	...
	coordinateToValue : function(a) {
		...
		return !0 === this.logarithmic ? Math.pow(10, (e ? !0 === d ? (b - a)
						/ c : a / c : !0 === d ? a / c : (b - a) / c)
						+ Math.log(g) * Math.LOG10E) : !0 === d ? e ? f
				- (a - b) / c : a / c + f : e ? a / c + f : f - (a - b) / c
	},
	getCoordinate : function(a) {
		if (isNaN(a))
			return NaN;
		var b = this.rotate, c = this.reversed, d = this.axisWidth, e = this.stepWidth, f = this.min, g = this.minReal;
		!0 === this.logarithmic ? (0 == a && (a = this.treatZeroAs), a = Math
				.log(a)
				* Math.LOG10E - Math.log(g) * Math.LOG10E, b = b ? !0 === c ? d
				- e * a : e * a : !0 === c ? e * a : d - e * a) : b = !0 === c
				? b ? d - e * (a - f) : e * (a - f)
				: b ? e * (a - f) : d - e * (a - f);
	...
	handleSynchronization : function(a) {
		...
		d
				&& (this.min = a * d, this.max = c * d, this.step = b * d, a = Math
						.pow(10, Math.floor(Math.log(Math.abs(this.step))
										* Math.LOG10E)), a = Math.abs(Math
						.log(Math.abs(a))
						* Math.LOG10E), this.maxDecCount = a = Math.round(a), this
						.draw())
	}
});
AmCharts.RecAxis = AmCharts.Class({
	construct : function(a) {
		...
		"H" == a.orientation
				? (d = AmCharts.line(p, [0, n], [0, 0], d, e, c), this.axisWidth = a.width, "bottom" == a.position
						? (a = c / 2 + f + m + l - 1, c = k)
						: (a = -c / 2 - f + l + h, c = g + k))
				: (this.axisWidth = a.height, "right" == a.position
						? (d = AmCharts.line(p, [0, 0, -g], [0, m, m - h], d,
								e, c), a = l + h, c = c / 2 + f + g + n + k - 1)
						: (d = AmCharts.line(p, [0, 0], [0, m], d, e, c), a = l, c = -c
								/ 2 - f + k));
		d.translate(c, a);
		b.axesSet.push(d);
		this.set = d
...
AmCharts.RecItem = AmCharts.Class({
	construct : function(a, b, c, d, e, f, g, h, k, l, m) {
		...
		g
				? (H = !0, isNaN(g.tickLength) || (u = g.tickLength), void 0 != g.lineColor
						&& (B = g.lineColor), void 0 != g.color
						&& (q = g.color), isNaN(g.lineAlpha)
						|| (x = g.lineAlpha), isNaN(g.dashLength)
						|| (z = g.dashLength), isNaN(g.lineThickness)
						|| (F = g.lineThickness), !0 === g.inside && (T = !0), isNaN(g.labelRotation)
						|| (m = g.labelRotation), isNaN(g.fontSize)
						|| (p = g.fontSize), g.position && (ma = g.position), void 0 !== g.boldLabel
						&& (h = g.boldLabel), isNaN(g.labelOffset)
						|| (fa = g.labelOffset))
				: "" === c && (u = 0);
		W = "start";
		e && (W = "middle");
		...
		var Z;
		H
				&& (Z = a.autoWrap && 0 === m ? AmCharts.wrappedText(r, c, q,
						n, p, W, h, e, 0) : AmCharts.text(r, c, q, n, p, W, h), W = Z
						.getBBox(), S = W.width, y = W.height);
		if ("H" == Na) {
			if (0 <= b
					&& b <= X + 1
					&& (0 < u
							&& 0 < s
							&& b + k <= X + 1
							&& ($ = AmCharts.line(r, [b + k, b + k], [0, u], v,
									s, F), t.push($)), 0 < x
							&& (W = AmCharts.line(r, [b, b + aa, b + aa], [O,
											O + ga, ga], B, x, F, z), t.push(W))), A = 0, G = b, g
					&& 90 == m && T && (G -= p), !1 === d
					? (W = "start", A = "bottom" == ma ? T ? A + u : A - u : T
							? A - u
							: A + u, G += 3, e
							&& (G += e / 2 - 3, W = "middle"), 0 < m
							&& (W = "middle"))
					: W = "middle", 1 == V
					&& 0 < E
					&& !g
					&& !l
					&& ba < X
					&& (d = AmCharts.fitToBounds(b, 0, X), ba = AmCharts
							.fitToBounds(ba, 0, X), ja = d - ba, 0 < ja
							&& (fill = AmCharts.rect(r, ja, a.height, I, E), fill
									.translate(d - ja + aa, ga), t.push(fill))), "bottom" == ma
					? (A += O + p / 2 + na, T ? (0 < m ? (A = O - S / 2
							* Math.sin(Y) - u - 3, G += S / 2 * Math.cos(Y) - 4
							+ 2) : 0 > m
							? (A = O + S * Math.sin(Y) - u - 3 + 2, G += -S
									* Math.cos(Y) - y * Math.sin(Y) - 4)
							: A -= u + p + 3 + 3, A -= fa) : (0 < m ? (A = O
							+ S / 2 * Math.sin(Y) + u + 3, G -= S / 2
							* Math.cos(Y)) : 0 > m
							? (A = O + u + 3 - S / 2 * Math.sin(Y) + 2, G += S
									/ 2 * Math.cos(Y))
							: A += u + w + 3 + 3, A += fa))
					: (A += ga + p / 2 - na, G += aa, T ? (0 < m
							? (A = S / 2 * Math.sin(Y) + u + 3, G -= S / 2
									* Math.cos(Y))
							: A += u + 3, A += fa) : (0 < m
							? (A = -(S / 2) * Math.sin(Y) - u - 6, G += S / 2
									* Math.cos(Y))
							: A -= u + p + 3 + w + 3, A -= fa)), "bottom" == ma
					? ja = (T ? O - u - 1 : O + w - 1) + na
					: (ka = aa, ja = (T ? ga : ga - u - w + 1) - na), f
					&& (G += f), f = G, 0 < m && (f += S / 2 * Math.cos(Y)), Z
					&& (p = 0, T && (p = S / 2 * Math.cos(Y)), f + p > X + 2
							|| 0 > f))
				Z.remove(), Z = null
		} else {
			0 <= b
					...
					&& (0 < u
							&& 0 < s
							&& b + k <= O + 1
							&& ($ = AmCharts.line(r, [0, u], [b + k, b + k], v,
									s, F), t.push($)), 0 < x
							&& (W = AmCharts.line(r, [0, aa, X + aa], [b,
											b + ga, b + ga], B, x, F, z), t
									.push(W)));
			W = "end";
			...
			1 == V
					...
					&& !g
					&& !l
					&& (d = AmCharts.fitToBounds(b, 0, O), ba = AmCharts
							.fitToBounds(ba, 0, O), Y = d - ba, fill = AmCharts
							.polygon(r, [0, a.width, a.width, 0], [0, 0, Y, Y],
									I, E), fill.translate(aa, d - Y + ga), t
							.push(fill));
			A += p / 2;
			"right" == ma ? (G += aa + X + na, A += ga, T ? (f
					|| (A -= p / 2 + 3), G = G - (u + 4) - fa) : (G += u + 4
					+ w, A -= 2, G += fa)) : T
					? (G += u + 4 - na, f || (A -= p / 2 + 3), g
							&& (G += aa, A += ga), G += fa)
					: (G += -u - w - 4 - 2 - na, A -= 2, G -= fa);
			$
					&& ("right" == ma ? (ka += aa + na + X, ja += ga, ka = T
							? ka - w
							: ka + w) : (ka -= na, T || (ka -= u + w)));
			f && (A += f);
			T = -3;
		...
		Z
				&& (Z.attr({
						...
						&& Z.rotate(-m, a.chart.backgroundColor), a.allLabels
						.push(Z), " " != c && (this.label = Z));
...
AmCharts.RecFill = AmCharts.Class({
	construct : function(a, b, c, d) {
		...
		k = a.chart.container;
		d = d.fillColor;
		"V" == g ? (b = AmCharts.fitToBounds(b, 0, a.viH), c = AmCharts
				.fitToBounds(c, 0, a.viH)) : (b = AmCharts.fitToBounds(b, 0,
				a.viW), c = AmCharts.fitToBounds(c, 0, a.viW));
		c -= b;
		isNaN(c) && (c = 4, h = 2, l = 0);
		0 > c && "object" == typeof d && (d = d.join(",").split(",").reverse());
		"V" == g ? (a = AmCharts.rect(k, a.width, c, d, l), a.translate(e, b
						- h + f)) : (a = AmCharts.rect(k, c, a.height, d, l), a
				.translate(b - h + e, f));
		this.set = k.set([a])
	},
	graphics : function() {
...
AmCharts.AmChart = AmCharts.Class({
	...
	drawBackground : function() {
		...
		this.background = b = AmCharts.polygon(a, [0, e - 1, e - 1, 0], [0, 0,
						f - 1, f - 1], b, c, 1, this.borderColor,
				this.borderAlpha);
		d.push(b);
	...
	initChart : function() {
		...
		b
				...
				&& (this.dmouseY = AmCharts.removePx(b
						.getPropertyValue("margin-top")), this.dmouseX = AmCharts
						.removePx(b.getPropertyValue("margin-left")));
		this.mouseMode = a;
		(a = this.container) ? (a.container.innerHTML = "", this.chartDiv
				.appendChild(a.container), a.setSize(this.realWidth,
				this.realHeight)) : a = new AmCharts.AmDraw(this.chartDiv,
				this.realWidth, this.realHeight, this);
		AmCharts.VML || AmCharts.SVG
				? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness = this.handDrawThickness, this.container = a, this.set
						&& this.set.remove(), this.set = a.set(), this.gridSet
						&& this.gridSet.remove(), this.gridSet = a.set(), this.cursorLineSet
						&& this.cursorLineSet.remove(), this.cursorLineSet = a
						.set(), this.graphsBehindSet
						&& this.graphsBehindSet.remove(), this.graphsBehindSet = a
						.set(), this.bulletBehindSet
						&& this.bulletBehindSet.remove(), this.bulletBehindSet = a
						.set(), this.columnSet && this.columnSet.remove(), this.columnSet = a
						.set(), this.graphsSet && this.graphsSet.remove(), this.graphsSet = a
						.set(), this.trendLinesSet
						&& this.trendLinesSet.remove(), this.trendLinesSet = a
						.set(), this.axesSet && this.axesSet.remove(), this.axesSet = a
						.set(), this.cursorSet && this.cursorSet.remove(), this.cursorSet = a
						.set(), this.scrollbarsSet
						&& this.scrollbarsSet.remove(), this.scrollbarsSet = a
						.set(), this.bulletSet && this.bulletSet.remove(), this.bulletSet = a
						.set(), this.freeLabelsSet
						&& this.freeLabelsSet.remove(), this.axesLabelsSet
						&& this.axesLabelsSet.remove(), this.axesLabelsSet = a
						.set(), this.freeLabelsSet = a.set(), this.balloonsSet
						&& this.balloonsSet.remove(), this.balloonsSet = a
						.set(), this.zoomButtonSet
						&& this.zoomButtonSet.remove(), this.zoomButtonSet = a
						.set(), this.linkSet && this.linkSet.remove(), this.linkSet = a
						.set(), this.renderFix())
				: this.fire("failed", {
							type : "failed",
							chart : this
	...
	measure : function() {
		...
		if (a) {
			...
			var f = AmCharts.removePx(AmCharts.getStyle(a, "padding-left")), g = AmCharts
					.removePx(AmCharts.getStyle(a, "padding-right")), h = AmCharts
			...
			this.balloon = AmCharts.processObject(this.balloon,
					AmCharts.AmBalloon, this.theme);
			this.balloon.chart = this;
			(a != this.previousWidth || f != this.previousHeight)
					&& 0 < a
					&& 0 < f
					&& (b.style.width = a + "px", b.style.height = f + "px", e
							&& e.setSize(a, f));
	...
	drawLabel : function(a) {
		if (this.container) {
			var b = a.y, c = a.text, d = a.align, e = a.size, f = a.color, g = a.rotation, h = a.alpha, k = a.bold, l = AmCharts
			...
			b += e / 2;
			c = AmCharts
					.text(this.container, c, f, this.fontFamily, e, d, k, h);
			c.translate(l, b);
			0 !== g && c.rotate(g);
	...
	validateData : function(a) {
		this.chartCreated
				&& (this.dataChanged = !0, this.marginsUpdated = "xy" != this.type
						? !1
						: !0, this.initChart(a))
	},
		...
		if (this.mouseIsOver) {
			...
			if (a) {
				...
				switch (this.mouseMode) {
					...
					case 0 :
						this.divIsFixed
								? (c = a.clientX - this.posX, d = a.clientY
										- this.posY)
								: (c = a.pageX - this.posX, d = a.pageY
										- this.posY)
				}
				a.touches
						&& (a = a.touches.item(0), c = a.pageX - this.posX, d = a.pageY
								- this.posY);
	...
	handleMouseDown : function(a) {
		...
		a
				&& a.preventDefault
				&& (this.panEventsEnabled ? a.preventDefault() : a.touches
						|| a.preventDefault())
	},
	...
	updateAnimations : function() {
		...
		for (a = this.animations.length - 1; 0 <= a; a--) {
			var b = this.animations[a], c = 1E3 * b.time / AmCharts.updateRate, d = b.frame
					+ 1, e = b.obj, f = b.attribute;
			if (d <= c) {
				b.frame++;
				var g = Number(b.from), h = Number(b.to) - g, c = AmCharts[b.effect](
						0, d, g, h, c);
				0 === h
						? (this.animations.splice(a, 1), e.node.style[f] = Number(b.to)
								+ b.suffix)
						: e.node.style[f] = c + b.suffix
			} else
				e.node.style[f] = Number(b.to) + b.suffix, this.animations
						.splice(a, 1)
		}
	},
	inIframe : function() {
	...
	brr : function() {
		...
		this.amLink && (a = this.amLink.parentNode)
		...
		if ("amcharts.com" != b || !0 === this.inIframe()) {
			...
			if ("serial" == this.type || "xy" == this.type)
				b = this.marginLeftReal, c = this.marginTopReal, d = b
						+ this.plotAreaWidth, e = c + this.plotAreaHeight;
			var f = "http://www.amcharts.com/javascript-charts/", g = "JavaScript charts", h = "JS chart by amCharts";
			"ammap" == this.product
					&& (f = "http://www.ammap.com/javascript-maps/", g = "Interactive JavaScript maps", h = "JS map by amCharts");
...
AmCharts.AmGraph = AmCharts.Class({
	construct : function(a) {
		...
		this.createEvents("rollOverGraphItem", "rollOutGraphItem",
				...
				"rightClickGraphItem", "clickGraph", "rollOverGraph",
				"rollOutGraph");
		this.type = "line";
		this.stackable = !0;
		this.columnCount = 1;
	...
	draw : function() {
		...
		d
				|| (c = this.valueAxis.stackType, d = "top", "column" == this.type
						&& (a.rotate && (d = "right"), "100%" == c
								|| "regular" == c) && (d = "middle"), this.labelPosition = d);
		AmCharts.ifArray(this.data)
				&& (a = !1, "xy" == b
						? this.xAxis.axisCreated && this.yAxis.axisCreated
								&& (a = !0)
						: this.valueAxis.axisCreated && (a = !0), !this.hidden
						&& a && this.createGraph())
	},
	createGraph : function() {
		...
		if (!isNaN(a.valueAxis.min) && !isNaN(a.valueAxis.max)) {
			switch (b.type) {
				case "serial" :
					a.categoryAxis
							&& (a.createSerialGraph(), "candlestick" == a.type
	...
	createXYGraph : function() {
		...
		for (e = this.start; e <= this.end; e++) {
			var f = this.data[e].axes[c.id].graphs[this.id], g = f.values, h = g.x, k = g.y, g = c
					.getCoordinate(h), l = d.getCoordinate(k);
			!isNaN(h)
					&& !isNaN(k)
					&& (a.push(g), b.push(l), h = this.createBullet(f, g, l, e), k = this.labelText)
					&& (f = this.createLabel(f, g, l, k), this.positionLabel(g,
							l, f, h), this.allBullets.push(f))
		}
	...
	createRadarGraph : function() {
		...
		for (f = this.start; f <= this.end; f++) {
			...
			if (isNaN(h))
				...
				var k = this.y
						- (this.valueAxis.getCoordinate(h) - this.height), l = 180
						- 360 / (this.end - this.start + 1) * f;
				...
				m
						&& (g = this.createLabel(g, h, k, m), this
								.positionLabel(h, k, g, l), this.allBullets
								.push(g));
				isNaN(d) && (d = h);
				isNaN(e) && (e = k)
			}
	...
	positionLabel : function(a, b, c, d, e, f) {
				...
				"column" == this.type
						&& (lC = !0, isRotated
								? isNegative
										...
										: (lA = "start", a = f + 3
												+ this.labelOffset)
								: b = isNegative ? g + 7 + this.labelOffset : g
										- 10 - this.labelOffset);
				break;
			case "middle" :
				"column" == this.type
						&& (lC = !0, isRotated ? a -= (a - f) / 2
								+ this.labelOffset - 3 : b -= (b - g) / 2
								+ this.labelOffset - 3)
		}
		...
		e
				&& lC
				&& (lBB.height > graphDataItem.columnHeight || lBB.width > graphDataItem.columnWidth)
				&& (c.remove(), c = !1);
	...
	createSerialGraph : function() {
		...
		isNaN(h) && (h = .8);
		var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate, r = this.columnCount, t = AmCharts
				.toCoordinate(this.cornerRadiusTop, h / 2), w = this.connect, v = [], s = [], u, x, F, B, z = this.chart.graphs.length, I, E = this.dx
				/ this.tcc, H = this.dy / this.tcc, V = f.stackType, T = this.start, fa = this.end, aa = this.scrollbar, ga = this.categoryAxis, Na = this.baseCoord, ma = this.negativeBase, ba = this.columnIndex, O = this.lineThickness, X = this.lineAlpha, na = this.lineColorR, $ = this.dashLength, W = this.set, Y, ja = this
				.getGradRotation(), G = this.chart.columnSpacing, A = ga.cellWidth, ka = (A
				* h - r)
				/ r;
		G > ka && (G = ka);
		...
		if (!(aa || "line" != g && "smoothedLine" != g && "step" != g || (1 == d.length
				&& "step" != g
				&& "none" == this.bullet
				&& (this.bullet = "round", this.resetBullet = !0), !Da
				&& void 0 == wa || l))) {
			var Ja = ma;
			Ja > f.max && (Ja = f.max);
			Ja < f.min && (Ja = f.min);
			...
			q
					? (eb = n, fb = Math.abs(Cb - Aa), hb = n, ib = Math.abs(Za
							- Aa), Ya = gb = 0, f.reversed
							? (Wa = 0, Xa = Aa)
							: (Wa = Aa, Xa = 0))
					: (fb = m, eb = Math.abs(Cb - Aa), ib = m, hb = Math.abs(Za
							- Aa), Xa = Wa = 0, f.reversed
							? (Ya = p, gb = Aa)
							: Ya = Aa + 1)
		}
		var Ba = Math.round;
		...
		var P = [], Q = [], Ea = !1;
		if ("line" == g || "step" == g || "smoothedLine" == g)
			if (this.stackable && "regular" == V || "100%" == V
					|| this.fillToGraph)
				Ea = !0;
		...
		for (J = T; J <= fa; J++) {
			...
			if (l && void 0 == this.openField)
				for (var kb = J + 1; kb < d.length
						&& (!d[kb] || !(Ra = d[J + 1].axes[f.id].graphs[b])
								|| !Ra.values || (Ga = Ra.values.value, isNaN(Ga))); kb++);
			...
			if (va) {
				U = this.stackable && "none" != V && "3d" != V
						? va.close
						: va.value;
				if ("candlestick" == g || "ohlc" == g)
					U = va.close, mb = va.low, xa = f.getCoordinate(mb), lb = va.high, ya = f
							.getCoordinate(lb);
				ia = va.open;
				C = f.getCoordinate(U);
				isNaN(ia)
						|| (K = f.getCoordinate(ia), l
								&& (Ga = ia, ia = K = NaN));
				l
						&& (void 0 == this.openField
								? Ra
										&& (Ra.isNegative = Ga < U ? !0 : !1, isNaN(Ga)
												&& (y.isNegative = !Fa))
								: y.isNegative = Ga > U ? !0 : !1);
				if (!aa)
				...
				var ha = S.x[ga.id], La = this.periodSpan - 1, la = Math
						.floor(A / 2)
						+ Math.floor(La * A / 2), za = la, cb = 0;
				"left" == this.stepDirection
						&& (cb = (2 * A + La * A) / 2, ha -= cb);
				"center" == this.stepDirection && (cb = A / 2, ha -= cb);
				"start" == this.pointPosition
						&& (ha -= A / 2 + Math.floor(La * A / 2), la = 0, za = Math
								.floor(A)
								+ Math.floor(La * A));
				"end" == this.pointPosition
						&& (ha += A / 2 + Math.floor(La * A / 2), la = Math
								.floor(A)
								+ Math.floor(La * A), za = 0);
				if (Eb) {
				...
				q ? (D = C, M = K, K = C = ha, isNaN(ia) && !this.fillToGraph
						&& (M = Na), Ha = xa, Ia = ya) : (M = D = ha, isNaN(ia)
						&& !this.fillToGraph && (K = Na));
				if (!nb && U < ia || nb && U < Y)
					y.isNegative = !0, Da && (Ca = Da), Pa && (Ka = Pa), void 0 != wa
							&& (ua = wa);
				Qa = !1;
				isNaN(U)
						|| (l ? U > Ga ? (Fa && (Qa = !0), Fa = !1) : (Fa
								|| (Qa = !0), Fa = !0) : y.isNegative = U < ma
								? !0
								: !1, Y = U);
				switch (g) {
					case "line" :
						if (isNaN(U))
							w
									|| (this.drawLineGraph(v, s, P, Q), v = [], s = [], P = [], Q = []);
						else {
							if (Math.abs(D - $a) >= bb
									|| Math.abs(C - ab) >= bb)
							...
							!Ea || isNaN(K) || isNaN(M)
									|| (P.push(M), Q.push(K));
							if (Qa || void 0 != y.lineColor
									|| void 0 != y.fillColors
									|| !isNaN(y.dashLength))
								this.drawLineGraph(v, s, P, Q), v = [D], s = [C], P = [], Q = [], !Ea
										|| isNaN(K)
										|| isNaN(M)
										|| (P.push(M), Q.push(K)), l
										? Fa
												? (this.lineColorSwitched = na, this.fillColorsSwitched = jb)
												: (this.lineColorSwitched = wa, this.fillColorsSwitched = Da)
										: (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors), this.dashLengthSwitched = y.dashLength;
							y.gap
									&& (this.drawLineGraph(v, s, P, Q), v = [], s = [], P = [], Q = [])
						}
						break;
					case "smoothedLine" :
						if (isNaN(U))
							w
									|| (this.drawSmoothedGraph(v, s, P, Q), v = [], s = [], P = [], Q = []);
						else {
							if (Math.abs(D - $a) >= bb
									|| Math.abs(C - ab) >= bb)
								v.push(D), s.push(C), $a = D, ab = C;
							...
							void 0 == y.lineColor
									&& void 0 == y.fillColors
									&& isNaN(y.dashLength)
									|| (this.drawSmoothedGraph(v, s, P, Q), v = [D], s = [C], P = [], Q = [], !Ea
											|| isNaN(K)
											|| isNaN(M)
											|| (P.push(M), Q.push(K)), this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength);
							y.gap
									&& (this.drawSmoothedGraph(v, s, P, Q), v = [], s = [], P = [], Q = [])
						}
						break;
					case "step" :
						if (!isNaN(U)) {
							q ? (isNaN(u) || (v.push(u), s.push(C - la)), s
									.push(C - la), v.push(D), s.push(C + za), v
									.push(D), !Ea
									|| isNaN(K)
									|| isNaN(M)
									|| (P.push(F), Q.push(K - la), P.push(M), Q
											.push(K - la), P.push(M), Q.push(K
											+ za))) : (isNaN(x)
									|| (s.push(x), v.push(u), s.push(x), v
											.push(D - la)), v.push(D - la), s
									.push(C), v.push(D + za), s.push(C), !Ea
									|| isNaN(K)
									|| isNaN(M)
									|| (P.push(M - la), Q.push(B), P.push(M
											- la), Q.push(K), P.push(M + za), Q
											.push(K)));
							u = D;
							x = C;
							F = M;
							...
							if (1 >= this.periodSpan || 1 < this.periodSpan
									&& D - u > la + za)
								u = x = NaN;
							this.drawLineGraph(v, s, P, Q);
							v = [];
						...
						if (!isNaN(U)) {
							...
							if (!(U < Gb && ia < Gb || U > Hb && ia > Hb)) {
								...
								if (q) {
									...
									ca += Tb - R;
									ca = AmCharts.fitToBounds(ca, -R, m - R + E
													* ba);
									N < n
											&& 0 < L
											&& (qa = new AmCharts.Cuboid(e, ca,
													L, E - a.d3x, H - a.d3y,
													Ca, Ka, O, oa, X, ja, t, q,
													$, Sa, Fb), y.columnWidth = Math
													.abs(ca), y.columnHeight = Math
													.abs(L))
								} else {
									"3d" == V
											? (R = D
									...
									ca += Ub - N;
									ca = AmCharts.fitToBounds(ca, -N + H * ba,
											n - N);
									R < m + ba * E
											&& 0 < L
											&& (this.showOnAxis && (N -= H / 2), qa = new AmCharts.Cuboid(
													e, L, ca, E - a.d3x, H
															- a.d3y, Ca, Ka, O,
													oa, this.lineAlpha, ja, t,
													q, $, Sa, Fb), y.columnHeight = Math
													.abs(ca), y.columnWidth = Math
													.abs(L))
								}
							}
							if (qa
									&& (ra = qa.set, y.columnGraphics = ra, ra
											.translate(R, N), this.columnsSet
											.push(ra), (y.url || this.showHandOnHover)
											&& ra.setAttr("cursor", "pointer"), !aa)) {
								"none" == V
										&& (I = q
												? (this.end + 1 - J) * z - c
												: z * J + c);
								"3d" == V
										&& (q
												? (I = (this.end + 1 - J) * z
														- c - 1E3
														* this.depthCount, sa += E
														* this.columnIndex, da += E
														* this.columnIndex, y.y += E
														* this.columnIndex)
												: (I = (z - c) * (J + 1) + 1E3
														* this.depthCount, ta += H
														* this.columnIndex, ea += H
														* this.columnIndex, y.y += H
														* this.columnIndex));
								if ("regular" == V || "100%" == V)
									I = q ? 0 < va.value ? (this.end + 1 - J)
											* z + c : (this.end + 1 - J) * z
											- c : 0 < va.value ? z * J + c : z
											* J - c;
							...
							if (q) {
								if (N = C - h / 2, R = M, L = h, N + L > n
									...
									!isNaN(Ia)
											...
											&& C < n
											&& 0 < C
											&& (db = AmCharts.line(e, qb,
													[C, C], oa, X, O), pb = AmCharts
													.line(e, rb, [C, C], oa, X,
															O));
									ca = D - M;
									qa = new AmCharts.Cuboid(e, ca, L, E, H,
											Ca, Oa, O, oa, X, ja, t, q, $, Sa)
								}
							} else if (R = D - h / 2, N = K + O / 2, L = h, R
									+ L > m
									&& (L = m - R), 0 > R && (L += R, R = 0), ca = C
									- K, R < m && 0 < L) {
								nb && U >= ia && (Ka = 0);
								var qa = new AmCharts.Cuboid(e, L, ca, E, H,
										Ca, Ka, O, oa, X, ja, t, q, $, Sa), sb, tb;
								U > ia ? (sb = [C, ya], tb = [K, xa]) : (sb = [
										K, ya], tb = [C, xa]);
								!isNaN(ya)
										&& !isNaN(xa)
										&& D < m
										&& 0 < D
										&& (db = AmCharts.line(e, [D, D], sb,
												oa, X, O), pb = AmCharts.line(
												e, [D, D], tb, oa, X, O))
							}
							qa
									&& (ra = qa.set, y.columnGraphics = ra, W
											.push(ra), ra.translate(R, N - O
													/ 2), (y.url || this.showHandOnHover)
											&& ra.setAttr("cursor", "pointer"), db
											&& (W.push(db), W.push(pb)), sa = D, ta = C, q
											? (ea = C, da = D, "open" == k
													&& (da = M), "high" == k
													&& (da = Ia), "low" == k
													&& (da = Ha))
											: (ea = C, "open" == k && (ea = K), "high" == k
													&& (ea = ya), "low" == k
													&& (ea = xa), da = D), aa
											|| (y.x = q ? N + L / 2 : R + L / 2, this
													.animateColumns(qa, J, D,
															M, C, K), this
													.addListeners(ra, y)))
						}
						break;
					case "ohlc" :
						if (!(isNaN(ia) || isNaN(lb) || isNaN(mb) || isNaN(U))) {
							U < ia
									&& (y.isNegative = !0, void 0 != wa
											&& (ua = wa));
							var ub, vb, wb;
							if (q) {
								var xb = C - h / 2, xb = AmCharts.fitToBounds(
										xb, 0, n), Ib = AmCharts.fitToBounds(C,
										0, n), yb = C + h / 2, yb = AmCharts
										.fitToBounds(yb, 0, n);
								vb = AmCharts.line(e, [M, M], [xb, Ib], ua, X,
										O, $);
								0 < C
										&& C < n
										&& (ub = AmCharts.line(e, [Ha, Ia], [C,
														C], ua, X, O, $));
								wb = AmCharts.line(e, [D, D], [Ib, yb], ua, X,
										O, $);
								ea = C;
								da = D;
								"open" == k && (da = M);
								...
								var zb = D - h / 2, zb = AmCharts.fitToBounds(
										zb, 0, m), Jb = AmCharts.fitToBounds(D,
										0, m), Ab = D + h / 2, Ab = AmCharts
										.fitToBounds(Ab, 0, m);
								vb = AmCharts.line(e, [zb, Jb], [K, K], ua, X,
										O, $);
								0 < D
										&& D < m
										&& (ub = AmCharts.line(e, [D, D], [xa,
														ya], ua, X, O, $));
								wb = AmCharts.line(e, [Jb, Ab], [C, C], ua, X,
										O, $);
								ea = C;
								"open" == k && (ea = K);
								"high" == k && (ea = ya);
				...
				if (!aa && !isNaN(U)) {
					...
					if (this.end - this.start <= Kb || 0 === Kb) {
						...
						if (Lb) {
							...
							(Bb = this.positionLabel(sa, ta, Bb, Vb, L, ca))
									&& this.allBullets.push(Bb)
						}
						if ("regular" == V || "100%" == V) {
							var Mb = f.totalText;
							if (Mb) {
								var Ma = this.createLabel(y, 0, 0, Mb,
										f.totalTextColor);
		...
		if ("line" == g || "step" == g || "smoothedLine" == g)
			"smoothedLine" == g ? this.drawSmoothedGraph(v, s, P, Q) : this
					.drawLineGraph(v, s, P, Q), aa || this.launchAnimation();
	...
	animateColumns : function(a, b, c, d, e, f) {
		...
		0 < c
				&& !g.animationPlayed
				&& (g.seqAn
						? (a.set.hide(), g.animationArray.push(a), a = setTimeout(
								function() {
									g.animate.call(g)
								}, c / (g.end - g.start + 1) * (b - g.start)
										* 1E3), g.timeOuts.push(a))
						: g.animate(a))
	},
	...
	drawLineGraph : function(a, b, c, d) {
		var e = this;
		if (1 < a.length) {
			var f = e.set, g = e.chart, h = e.container, k = h.set(), l = h
					.set();
			f.push(l);
			f.push(k);
			...
			0 !== e.negativeBase
					&& (u = e.valueAxis.getCoordinate(e.negativeBase));
			...
			void 0 === t
					...
					|| (n = AmCharts.line(h, a, b, t, q, n, w, !1, !0), l
							.push(n));
			if (0 < f || 0 < s)
				if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m
						? 0 < c.length ? (c.reverse(), d.reverse(), n = a
								.concat(c), q = b.concat(d)) : e.rotate
								? (q.push(q[q.length - 1]), n.push(u), q
										.push(q[0]), n.push(u), q.push(q[0]), n
										.push(n[0]))
								: (n.push(n[n.length - 1]), q.push(u), n
										.push(n[0]), q.push(u), n.push(a[0]), q
										.push(q[0]))
						: "xy" == m
								&& (b = e.fillToAxis)
								&& (AmCharts.isString(b)
										&& (b = g.getValueAxisById(b)), "H" == b.orientation
										? (u = "top" == b.position ? 0 : b.viH, n
												.push(n[n.length - 1]), q
												.push(u), n.push(n[0]), q
												.push(u), n.push(a[0]), q
												.push(q[0]))
										: (u = "left" == b.position ? 0 : b.viW, q
												.push(q[q.length - 1]), n
												.push(u), q.push(q[0]), n
												.push(u), q.push(q[0]), n
												.push(n[0]))), a = e.gradientRotation, 0 < f
						&& (g = AmCharts
								.polygon(h, n, q, r, f, 1, "#000", 0, a), g
								.pattern(e.pattern), k.push(g)), v
						|| void 0 !== t)
					isNaN(s) && (s = f), v || (v = t), h = AmCharts.polygon(h,
							n, q, v, s, 1, "#000", 0, a), h.pattern(e.pattern), l
							.push(h), l.click(function(a) {
								e.handleGraphEvent(a, "clickGraph")
							}).mouseover(function(a) {
								e.handleGraphEvent(a, "rollOverGraph")
							}).mouseout(function(a) {
	...
	drawSmoothedGraph : function(a, b, c, d) {
		if (1 < a.length) {
			...
			g.push(k.path);
			void 0 !== q
					&& (l = new AmCharts.Bezier(f, a, b, q, v, l, p, 0, e), h
							.push(l.path));
			0 < m
					&& (k = a.join(";").split(";"), n = b.join(";").split(";"), l = "", 0 < c.length
							? (c.push("M"), d.push("M"), c.reverse(), d
									.reverse(), k = a.concat(c), n = b
									.concat(d))
							: (this.rotate ? (l += " L" + w + ","
									+ b[b.length - 1], l += " L" + w + ","
									+ b[0]) : (l += " L" + a[a.length - 1]
									+ "," + w, l += " L" + a[0] + "," + w), l += " L"
									+ a[0] + "," + b[0]), c = new AmCharts.Bezier(
							f, k, n, NaN, 0, 0, p, m, e, l), c.path
							.pattern(this.pattern), g.push(c.path), r
							|| void 0 !== q)
					&& (t || (t = m), r || (r = q), a = new AmCharts.Bezier(f,
							a, b, NaN, 0, 0, r, t, e, l), a.path
							.pattern(this.pattern), h.push(a.path));
			this.applyMask(h, g)
		}
	},
	launchAnimation : function() {
		...
		if (0 < b && !a.animationPlayed) {
			...
			a.seqAn ? (b = setTimeout(function() {
					...
					}, a.index * b * 1E3), a.timeOuts.push(b)) : a
					.animateGraphs()
		}
	},
	animateGraphs : function() {
		...
		b
				&& (this.rotate
						...
						: (b.translate(d, -1E3), c.translate(d, -1E3)), b
						.animate({
									opacity : 1,
									translate : d + "," + e
								}, f, a), c.animate({
	...
	animate : function(a) {
		...
		b = b.startDuration;
		a
				&& (this.rotate ? a.animateWidth(b, c) : a.animateHeight(b, c), a.set
						.show())
	},
	legendKeyColor : function() {
		var a = this.legendColor, b = this.lineAlpha;
		void 0 === a
				&& (a = this.lineColorR, 0 === b && (b = this.fillColorsR)
	...
	legendKeyAlpha : function() {
		...
		void 0 === a
				&& (a = this.lineAlpha, this.fillAlphas > a
	...
	createBullet : function(a, b, c, d) {
		if (!isNaN(b) && !isNaN(c)) {
			...
			isNaN(h)
					|| (isNaN(g) || (f = (g - k) / (h - k) * (l - m) + m), k == h
							&& (f = l));
			h = f;
			this.bulletAxis
					&& (f = a.values.error, isNaN(f) || (g = f), f = this.bulletAxis.stepWidth
							* g);
			f < this.minBulletSize && (f = this.minBulletSize);
			this.rotate ? b = a.isNegative ? b - e : b + e : c = a.isNegative
					? c + e
					: c - e;
			...
			var p;
			"xy" == this.chart.type && this.valueField
			...
			if (this.customBullet || a.customBullet)
				p = this.customBullet, a.customBullet && (p = a.customBullet), p
						&& (n && n.remove(), "function" == typeof p
								? (n = new p, n.chart = this.chart, a.bulletConfig
										&& (n.availableSpace = c, n.graph = this, n.graphDataItem = a, n.bulletY = c, a.bulletConfig.minCoord = this.minCoord
												- c, n.bulletConfig = a.bulletConfig), n
										.write(d), n = n.set)
								: (this.chart.path && (p = this.chart.path + p), n = d
										.set(), d = d.image(p, 0, 0, f, f), n
										.push(d), this.centerCustomBullets
										&& d.translate(-f / 2, -f / 2)));
			n
					&& ((a.url || this.showHandOnHover)
							&& n.setAttr("cursor", "pointer"), "serial" == this.chart.type
							&& (0 > b - 0 || b - 0 > this.width || c < -f / 2 || c
									- 0 > this.height)
							&& (n.remove(), n = null), n
							&& (this.bulletSet.push(n), n.translate(b, c), this
									.addListeners(n, a), this.allBullets
									.push(n)), a.bx = b, a.by = c);
	...
	handleRollOver : function(a, b) {
		if (a) {
			...
			c.chartCursor
					&& "serial" == c.type
					&& (d = !1, !c.chartCursor.valueBalloonsEnabled
			...
			if (d) {
				...
				c.showBalloon(d, e, !0, f + c.marginLeftReal, g
								+ c.marginTopReal)
			}
		}
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	draw : function() {
		...
		d || (d = b.valueAxes[0]);
		a.valueLineAxis = d;
		a.valueLineBalloonEnabled
				&& (d = new AmCharts.AmBalloon, a.vaBalloon = d, AmCharts
						.copyProperties(c, d), d.animationDuration = 0, a.rotate
						|| (d.pointerOrientation = "H"));
		...
		if (a.valueBalloonsEnabled)
			for (c = 0; c < b.graphs.length; c++)
				d = new AmCharts.AmBalloon, d.chart = b, AmCharts
						.copyProperties(b.balloon, d), b.graphs[c].valueBalloon = d;
	...
	createCursor : function() {
		...
		a
				? (e = [0, k, k + g], f = [0, 0, h], g = [g, 0, 0], h = [h, 0,
						l])
				: (e = [g, 0, 0], f = [h, 0, l], g = [0, k, k + g], h = [0, 0,
						h]);
		this.line = e = AmCharts.line(this.container, e, f, this.cursorColor,
				b, 1);
		(f = this.fullRectSet)
				? (f.push(e), f.translate(this.x, this.y))
				: this.set.push(e);
		this.valueLineEnabled
				&& (e = this.valueLineAlpha, isNaN(e) || (b = e), this.vLine = b = AmCharts
						.line(this.container, g, h, this.cursorColor, b, 1), this.set
						.push(b));
		this.setBalloonBounds(d, c, a);
		(c = this.vaBalloon)
				&& this.setBalloonBounds(c, this.valueLineAxis, !a);
		this.hideCursor()
	},
	createCrosshair : function() {
		var a = this.cursorAlpha, b = this.container, c = AmCharts.line(b, [0,
		...
		if (a.mouseIsOver) {
			...
			-.5 < b && b < this.width + 1 && 0 < c && c < this.height
					? (this.drawing ? this.rolledOver
							...
							&& (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, (this.valueLineEnabled || this.valueLineBalloonEnabled)
							&& this.updateVLine(b, c), this.setPosition())
					: this.rolledOver
	...
	updateVLine : function(a, b) {
		...
		if ((c || d) && !this.panning && !this.drawing) {
			...
			g
					? (c && c.translate(a, 0), e
							&& (f = e.coordinateToValue(a)), c = a)
					: (c && c.translate(0, b), e
							&& (f = e.coordinateToValue(b)), c = b - 1);
	...
	getMousePosition : function() {
		...
		this.rotate
				...
				: (a = a.mouseX - this.x - 1, 0 > a && (a = 0), a > b
						&& (a = b));
		return a
	},
	updateCrosshair : function() {
		var a = this.chart, b = a.mouseX - this.x, c = a.mouseY - this.y, d = this.vLine, e = this.hLine, b = AmCharts
				.fitToBounds(b, 0, this.width), c = AmCharts.fitToBounds(c, 0,
				this.height);
		0 < this.cursorAlpha
	...
	updateSelectionSize : function(a, b) {
		...
		isNaN(a)
				|| (c > a && (e = a, g = c - a), c < a && (e = c, g = a - c), c == a
						&& (e = a, g = 0), g += this.extraWidth, e -= this.extraWidth
						/ 2);
		isNaN(b)
				|| (d > b && (f = b, h = d - b), d < b && (f = d, h = b - d), d == b
						&& (f = b, h = 0), h += this.extraWidth, f -= this.extraWidth
						/ 2);
		0 < g
				&& 0 < h
				&& (c = AmCharts.rect(this.container, g, h, this.cursorColor,
						this.selectionAlpha), c.translate(e + this.x, f
								+ this.y), this.selection = c)
	},
	...
	arrangeBalloons2 : function() {
		...
		for (e = 0; e < f; e++) {
			...
			0 < e
					&& b - h < d + 3
					&& (g.setBounds(c, d + 3, c + this.width, d + h + 3), g.prevX = this.prevX[k], g.prevY = this.prevY[k], g.prevTX = this.prevTX[k], g.prevTY = this.prevTY[k], g
							.draw());
			g.set && g.set.show();
		...
		for (c = 0; c < b.length; c++) {
			...
			if (!d.hidden && d.balloonText) {
				...
				if (!isNaN(f)) {
					...
					d = AmCharts.circle(a, this.bulletSize / 2, this.chart
									.getBalloonColor(d, e, !0),
							d.cursorBulletAlpha);
					d.translate(h, f);
	...
	zoom : function(a, b, c, d) {
		...
		a = d.stepWidth;
		this.fullWidth
				&& (f = 1, d.parseDates && !d.equalSpacing
						&& (f = d.minDuration()), e
						? this.extraWidth = c = a * f
						: (this.extraWidth = b = a * f, this.categoryBalloon.minWidth = b), this.line
						&& this.line.remove(), this.line = AmCharts.rect(
						this.container, b, c, this.cursorColor,
						this.cursorAlpha, 0), this.fullRectSet
	...
	setPosition : function(a, b, c) {
		...
		if ("cursor" == this.type) {
			if (this.tempPosition = NaN, AmCharts.ifArray(this.data))
				isNaN(a) && (a = this.getMousePosition()), (a != this.previousMousePosition
						|| !0 === this.zoomed || this.oneBalloonOnly)
						&& !isNaN(a)
						&& ("mouse" == this.cursorPosition
								&& (this.tempPosition = a), isNaN(c)
								&& (c = this.chart.categoryAxis.xToIndex(a)), c != this.previousIndex
								|| this.zoomed
								|| "mouse" == this.cursorPosition
								|| this.oneBalloonOnly)
						&& (this.updateCursor(c, b), this.zoomed = !1), this.previousMousePosition = a
		} else
	...
	normalizeBulletSize : function() {
		...
		if (a)
			for (var b = 0; b < a.length; b++) {
				...
				d
						&& (d.translate(c.bx, c.by, 1), c = c.graph, isNaN(this.graphBulletAlpha)
								|| (d.setAttr("fill-opacity", c.bulletAlpha), d
										.setAttr("stroke-opacity",
												c.bulletBorderAlpha)))
			}
	},
	updateCursor : function(a, b) {
		var c = this.chart, d = this.fullWidth, e = c.mouseX - this.x, f = c.mouseY
				- this.y;
		this.drawingNow
		...
		if (this.enabled) {
			...
			var g = c.categoryAxis, h = c.dx, k = c.dy, l = this.x + 1, m = this.y
					+ 1, n = this.width, p = this.height, q = this.data[a];
			this.fireMoved();
			if (q) {
				...
				if (c.mouseIsOver || F || B || this.forceShow)
					if (this.forceShow = !1, B) {
						var h = this.panClickPos, c = this.panClickEndTime, F = this.panClickStartTime, I = this.panClickEnd, l = this.panClickStart, e = (t
								? h - f
								: h - e)
								/ w;
						...
						0 !== e
								&& (h = {
									...
									target : this
										...
										? (c + e > u && (e = u - c), F + e < s
												&& (e = s - F), h.start = Math
												.round(F + e), h.end = Math
												.round(c + e), this.fire(
												h.type, h))
										: I + e >= this.data.length
												|| 0 > l + e
												|| (h.start = l + e, h.end = I
														+ e, this.fire(h.type,
														h)))
					} else {
						"start" == x ? r -= g.cellWidth / 2 : "mouse" == x
								&& (c.mouseIsOver
										? r = t ? f - 2 : e - 2
										: isNaN(this.tempPosition)
												|| (r = this.tempPosition - 2));
						if (t) {
							if (0 > r)
								if (F)
									r = 0;
						...
						if (0 < this.cursorAlpha) {
							...
							0 < w && !this.zooming ? isNaN(this.previousX) ? E
									.translate(s, u) : (E.translate(
									this.previousX, this.previousY), E.animate(
									{
										translate : s + "," + u
						...
						F
								&& (d && E.hide(), t ? this
										.updateSelectionSize(NaN, r) : this
										.updateSelectionSize(r, NaN));
						w = !0;
						F && (w = !1);
						this.categoryBalloonEnabled && w
								? (this.setBalloonPosition(v, g, r, t), (s = this.categoryBalloonFunction)
										? v.showBalloon(s(q.category))
										: g.parseDates
												? (g = AmCharts
														.formatDate(
																q.category,
														...
														.showBalloon(g))
												: v
														.showBalloon(AmCharts
																.fixNewLines(q.category)))
								: v.hide();
						...
						if (this.oneBalloonOnly) {
							...
							for (g = 0; g < z.length; g++)
								s = z[g], s.showBalloon
										&& !s.hidden
										&& s.balloonText
										&& (u = q.axes[s.valueAxis.id].graphs[s.id], v = u.y, isNaN(v)
												|| (t
														? Math.abs(e - v) < r
																&& (r = Math
																		.abs(e
						...
						if (a != this.previousIndex
								|| I != this.previousMostCloseGraph)
							if (this.normalizeBulletSize(), this
									.destroyValueBalloons(), this.resizedBullets = [], z
									&& this.valueBalloonsEnabled
									&& w
									&& c.balloon.enabled) {
								this.valueBalloons = w = [];
								for (g = 0; g < z.length; g++)
									if (s = z[g], v = NaN, (!this.oneBalloonOnly || s == I)
											&& s.showBalloon
											&& !s.hidden
											&& s.balloonText
											&& ("step" == s.type
													&& "left" == s.stepDirection
													&& (q = this.data[a + 1]), q)) {
										if (u = q.axes[s.valueAxis.id].graphs[s.id])
											v = u.y;
										if (this.showNextAvailable && isNaN(v)
										...
										if (!isNaN(v)) {
											...
											if (t) {
												...
												k = !1;
											k
													&& (k = this.graphBulletSize, E = this.graphBulletAlpha, 1 == k
															&& isNaN(E)
															|| !AmCharts.isModern
															|| !(x = u.bulletGraphics)
															|| (x.getBBox(), x
																	...
																	|| (x
																			...
																			.setAttr(
																					"stroke-opacity",
																					E))), k = s.valueBalloon, E = c
															.getBalloonColor(s,
																	u), k
															.setBounds(l, m,
																	l + n, m
																			+ p), k.pointerOrientation = "H", x = this.balloonPointerOrientation, "vertical" == x
															&& (k.pointerOrientation = "V"), "horizontal" == x
															&& (k.pointerOrientation = "H"), k
															.changeColor(E), void 0 !== s.balloonAlpha
															&& (k.fillAlpha = s.balloonAlpha), void 0 !== s.balloonTextColor
															&& (k.color = s.balloonTextColor), k
															.setPosition(r + l,
																	d + m), r = c
															.formatString(
																	s.balloonText,
																	u, !0), (d = s.balloonFunction)
															&& (r = d(u, s)
																	.toString()), "" !== r
															&& (t
																	? k
						...
						b
								? (h = {
									type : "changed"
								}, h.index = a, h.chart = this.chart, h.zooming = F, h.mostCloseGraph = I, h.position = t
										? f
										: e, h.target = this, c.fire("changed",
										h), this.fire("changed", h), this.skipZoomDispatch = !1)
								: (this.skipZoomDispatch = !0, c
	...
	setBalloonPosition : function(a, b, c, d) {
		...
		d
				? (f
						&& ("right" == e ? a.setBounds(k, l + g, k + m + h, l
										+ c + g) : a.setBounds(k, l + g, k + m
										+ h, l + c)), "right" == e ? f ? a
						.setPosition(k + m + h, l + c + g) : a.setPosition(k
								+ m + h + b, l + c + g) : f ? a.setPosition(k,
						l + c) : a.setPosition(k - b, l + c))
				: "top" == e ? f ? a.setPosition(k + c + h, l + g) : a
						.setPosition(k + c + h, l + g - b + 1) : f ? a
						.setPosition(k + c, l + n) : a.setPosition(k + c, l + n
								+ b - 1)
	},
	setBalloonBounds : function(a, b, c) {
		...
		c
				? (e && (a.pointerWidth = 0), "right" == d ? e ? a.setBounds(l,
						m + h, l + n + k, m + p + h) : a.setBounds(l + n + k
								+ f, m + h, l + n + 1E3, m + p + h) : e ? a
						.setBounds(l, m, n + l, p + m) : a.setBounds(-1E3,
						-1E3, l - g - f, m + p + 15))
				: (a.maxWidth = n, b.parseDates && (g = 0, a.pointerWidth = 0), "top" == d
						? e ? a.setBounds(l + k, m + h, n + k + l, p + m) : a
								.setBounds(l + k, -1E3, n + k + l, m + h - g
												- f)
						: e ? a.setBounds(l, m, n + l, p + m - g) : a
								.setBounds(l, m + p + g + f - 1, l + n, m + p
												+ g + f))
	},
				...
				if (this.pan)
					...
					if ("cursor" == this.type)
						this.rotate
								...
								: this.selectionPosX = e = d, 4 > Math.abs(e
								- this.initialMouse)
								&& this.fromIndex == this.index
								|| (this.index < this.fromIndex
										? (c.end = this.fromIndex, c.start = this.index)
										: (c.end = this.index, c.start = this.fromIndex), e = a.categoryAxis, e.parseDates
										&& !e.equalSpacing
										&& (b[c.start]
												&& (c.start = b[c.start].time), b[c.end]
												&& (c.end = a
														.getEndTime(b[c.end].time))), this.skipZoomDispatch
										|| this.fire(c.type, c));
					else {
						var g = this.initialMouseX, h = this.initialMouseY;
						3 > Math.abs(d - g)
								&& 3 > Math.abs(e - h)
								|| (b = Math.min(g, d), f = Math.min(h, e), d = Math
										.abs(g - d), e = Math.abs(h - e), a.hideXScrollbar
										&& (b = 0, d = this.width), a.hideYScrollbar
										&& (f = 0, e = this.height), c.selectionHeight = e, c.selectionWidth = d, c.selectionY = f, c.selectionX = b, this.skipZoomDispatch
										|| this.fire(c.type, c))
					}
	...
	handleMouseDown : function(a) {
		if (this.zoomable || this.pan || this.drawing) {
			var b = this.rotate, c = this.chart, d = c.mouseX - this.x, e = c.mouseY
					- this.y;
			if (0 < d && d < this.width && 0 < e && e < this.height
				...
				this.setPosition(), this.selectWithoutZooming
						...
						? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0)
						: this.pan
								? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b
										? e
										: d, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime)
								: this.zoomable
										&& ("cursor" == this.type
												? (this.fromIndex = this.index, b
														? (this.initialMouse = e, this.selectionPosY = this.linePos)
														: (this.initialMouse = d, this.selectionPosX = this.linePos))
												: (this.initialMouseX = d, this.initialMouseY = e, this.selectionPosX = d, this.selectionPosY = e), this.zooming = !0)
		}
	}
});
AmCharts.SimpleChartScrollbar = AmCharts.Class({
	...
	draw : function() {
		...
		a.width = f;
		if ((a.height = g) && f) {
			var h = AmCharts.rect(b, f, g, a.backgroundColor,
					a.backgroundAlpha, 1, a.backgroundColor, a.backgroundAlpha);
			a.bg = h;
			e.push(h);
			...
			h = AmCharts.rect(b, f, g, a.selectedBackgroundColor,
			...
			f = d.pathToImages;
			c
					? (h = f + "dragIconH.gif", f = a.dragIconWidth, c = a.dragIconHeight)
					: (h = f + "dragIcon.gif", c = a.dragIconWidth, f = a.dragIconHeight);
			g = b.image(h, 0, 0, c, f);
			var h = b.image(h, 0, 0, c, f), k = 10, l = 20;
			d.panEventsEnabled && (k = 25, l = a.scrollbarHeight);
			var m = AmCharts.rect(b, k, l, "#000", .005), n = AmCharts.rect(b,
					k, l, "#000", .005);
	...
	updateScrollbarSize : function(a, b) {
		...
		this.rotate
				? (d = 0, e = a, f = this.width + 1, g = b - a, c.setAttr(
						"height", b - a), c.setAttr("y", e))
				: (d = a, e = 0, f = b - a, g = this.height + 1, c.setAttr(
						"width", b - a), c.setAttr("x", d));
		this.clipAndUpdate(d, e, f, g)
	},
	updateScrollbar : function() {
		var a, b = !1, c, d, e = this.x, f = this.y, g = this.dragger, h = this
				.getDBox();
		if (h) {
			c = h.x + e;
			d = h.y + f;
			...
			m.mouseIsOver
					&& (this.dragging
							&& (m = this.initialCoord, l
									? (a = m + (r - a), 0 > a && (a = 0), m = p
											- h, a > m && (a = m), g.setAttr(
											"y", a))
									: (a = m + (q - a), 0 > a && (a = 0), m = n
											- k, a > m && (a = m), g.setAttr(
											"x", a)), this.clipDragger(!0)), this.resizingRight
							&& (l
									? (a = r - d, a + d > p + f
											&& (a = p - d + f), 0 > a
									...
									: (a = q - c, a + c > n + e
											...
											: (0 === a && (a = .1), g.setAttr(
													"width", a))), this
									.clipDragger(!0)), this.resizingLeft
							&& (l
									? (c = d, d = r, d < f && (d = f), d > p
											+ f
											&& (d = p + f), a = !0 === b ? c
											- d : h + c - d, 0 > a
											? (this.resizingRight = !0, this.resizingLeft = !1, g
													.setAttr("y", c + h - f))
											: (0 === a && (a = .1), g.setAttr(
													"y", d - f), g.setAttr(
													"height", a)))
	...
	clipDragger : function(a) {
		...
		if (b) {
			...
			if (this.rotate) {
				if (c = 0, e = this.width + 1, this.clipY != d
						|| this.clipH != b)
					f = !0
	...
	updateDragIconPositions : function() {
		...
		this.rotate
				? (f = this.dragIconWidth, g = this.dragIconHeight, d
						.translate((h - g) / 2, c - f / 2), e.translate((h - g)
								/ 2, c + a.height - f / 2))
				: (f = this.dragIconHeight, g = this.dragIconWidth, d
						.translate(b - g / 2, (h - f) / 2), e.translate(b - g
								/ 2 + a.width, (h - f) / 2))
	},
	...
	handleBgClick : function() {
		...
		if (!a.resizingRight && !a.resizingLeft) {
			...
			l
					? (b = "y", c = c.mouseY - f / 2 - h, c = AmCharts
							.fitToBounds(c, 0, a.height - f))
					: (b = "x", c = c.mouseX - g / 2 - k, c = AmCharts
							.fitToBounds(c, 0, a.width - g));
			a.updateOnReleaseOnly
					? (a.skipEvent = !1, e.setAttr(b, c), a
							.dispatchScrollbarEvent(), a.clipDragger())
					: (c = Math.round(c), l ? e.animate({
								y : c
							}, d, ">") : e.animate({
								x : c
							}, d, ">"), a.forceClip = !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(
							function() {
...
AmCharts.ChartScrollbar = AmCharts.Class({
	...
	init : function() {
		...
		if (a = this.graph) {
			...
			c
					|| (this.valueAxis = c = new AmCharts.ValueAxis, c.visible = !1, c.scrollbar = !0, c.axisItemRenderer = AmCharts.RecItem, c.axisRenderer = AmCharts.RecAxis, c.guideFillRenderer = AmCharts.RecFill, c.labelsEnabled = !1, c.chart = b);
			b = this.unselectedGraph;
			b
					|| (b = new AmCharts.AmGraph, b.scrollbar = !0, this.unselectedGraph = b, b.negativeBase = a.negativeBase, b.noStepRisers = a.noStepRisers);
			b = this.selectedGraph;
			b
					|| (b = new AmCharts.AmGraph, b.scrollbar = !0, this.selectedGraph = b, b.negativeBase = a.negativeBase, b.noStepRisers = a.noStepRisers)
		}
	...
	dispatchScrollbarEvent : function() {
		if (this.skipEvent)
			...
			if (h.parseDates && !h.equalSpacing) {
				if (a = g.lastTime, g = g.firstTime, h.minDuration(), h = Math
						.round(b / k)
						+ g, b = this.dragging ? h + this.timeDifference : Math
						.round((b + c) / k)
						+ g, h > b && (h = b), 0 < e
						&& b - h < e
						&& (b = Math.round(h + (b - h) / 2), d = Math.round(e
								/ 2), h = b - d, b += d, d = !0), b > a
						&& (b = a), b - e < h && (h = b - e), h < g && (h = g), h
						+ e > b
						&& (b = h + e), h != this.startTime
						|| b != this.endTime)
					this.startTime = h, this.endTime = b, f.start = h, f.end = b, f.startDate = new Date(h), f.endDate = new Date(b), this
							.fire(f.type, f)
			} else if (h.startOnAxis || (b += k / 2), c -= this.stepWidth / 2, e = h
					.xToIndex(b), b = h.xToIndex(b + c), e != this.start
					|| this.end != b)
				h.startOnAxis
						&& (this.resizingRight && e == b && b++, this.resizingLeft
								&& e == b && (0 < e ? e-- : b = 1)), this.start = e, this.end = this.dragging
						? this.start + this.difference
						: b, f.start = this.start, f.end = this.end, h.parseDates
						&& (a[this.start]
	...
	zoomScrollbar : function() {
		...
		d.parseDates && !d.equalSpacing
				? (c = d.stepWidth, d = a.firstTime, a = c
						* (this.startTime - d), b = c * (this.endTime - d))
				: (a = c[this.start].x[d.id], b = c[this.end].x[d.id], c = d.stepWidth, d.startOnAxis
						|| (d = c / 2, a -= d, b += d));
		this.stepWidth = c;
...
AmCharts.AmBalloon = AmCharts.Class({
	...
	draw : function() {
		...
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				isNaN(B) || (z = "min-width:" + (B - 2 * r) + "px; ");
				m.innerHTML = '<div style="text-align:' + this.textAlign + "; "
						+ z + "max-width:" + this.maxWidth + "px; font-size:"
						+ x + "px; color:" + this.color + "; font-family:" + u
						+ '">' + this.text + "</div>";
				...
				"H" != v
						? (B = a - z / 2, b < h + u + 10 && "down" != v
								? (I = !0, d && (b += x), x = b + w, this.deltaSignY = -1)
								: (d && (b -= x), x = b - u - w, this.deltaSignY = 1))
						: (2 * w > u && (w = u / 2), x = b - u / 2, a < g
								+ (k - g) / 2
								? (B = a + w, this.deltaSignX = -1)
								: (B = a - z - w, this.deltaSignX = 1));
				x + u >= l && (x = l - u);
				x < h && (x = h);
				B < g && (B = g);
				B + z > k && (B = k - z);
				...
				0 < s || 0 === w
						? (0 < t
								&& (a = AmCharts.rect(e, z, u, n, 0, r + 1, E,
										t, this.cornerRadius), AmCharts.isModern
										? a.translate(1, 1)
										: a.translate(4, 4), f.push(a)), n = AmCharts
								.rect(e, z, u, n, this.fillAlpha, r, p,
										this.borderAlpha, this.cornerRadius), this.showBullet
								&& (V = AmCharts
										.circle(e, H, q, this.fillAlpha), f
										.push(V)))
						: (q = [], s = [], "H" != v ? (g = a - B, g > z - w
								&& (g = z - w), g < w && (g = w), q = [0,
								g - w, a - B, g + w, z, z, 0, 0], s = I ? [0,
								0, b - x, 0, 0, u, u, 0] : [u, u, b - x, u, u,
								0, 0, u]) : (q = b - x, q > u - w
								&& (q = u - w), q < w && (q = w), s = [0,
								q - w, b - x, q + w, u, u, 0, 0], q = a < g
								+ (k - g) / 2 ? [0, 0, B < a ? 0 : a - B, 0, 0,
								z, z, 0] : [z, z, B + z > a ? z : a - B, z, z,
								0, 0, z]), 0 < t
								&& (a = AmCharts
										.polygon(e, q, s, n, 0, r, E, t), a
										.translate(1, 1), f.push(a)), n = AmCharts
								.polygon(e, q, s, n, this.fillAlpha, r, p,
										this.borderAlpha));
				this.bg = n;
				f.push(n);
				n.toFront();
				...
				0 < this.animationDuration
						...
						&& (f.translate(this.prevX, this.prevY), f.animate({
								...
								&& (F.left = this.prevTX + "px", F.top = this.prevTY
										+ "px", this.xAnim = c.animate({
											node : m
										}, "left", this.prevTX, l, b,
										"easeOutSine", "px"), this.yAnim = c
										.animate({
													node : m
												}, "top", this.prevTY, h, b,
												"easeOutSine", "px")));
		...
		if (this.follow && this.show) {
			...
			if (a != this.previousX || b != this.previousY)
				if (this.previousX = a, this.previousY = b, 0 === this.cornerRadius)
					...
					var c = this.set;
					if (c) {
						var d = c.getBBox(), a = a - d.width / 2, e = b
								- d.height - 10;
						a < this.l && (a = this.l);
	...
	followCursor : function(a) {
		...
		!isNaN(c)
				&& a
				&& (b.pointToX = c - b.offsetX * b.deltaSignX, b.pointToY = d, b
						.followMouse(), b.interval = setInterval(function() {
...
AmCharts.AmCoordinateChart = AmCharts.Class({
	...
	initChart : function() {
		...
		a
				&& (this.categoryAxis = AmCharts.processObject(a,
						AmCharts.CategoryAxis, this.theme));
	...
	parseSerialData : function() {
		...
		if (e) {
			...
			h
					&& (f = h.parseDates, k = h.forceShowField, l = h.labelColorField, g = h.categoryFunction);
			var m, n, p = {}, q;
			f
					&& (b = AmCharts.extractPeriod(h.minPeriod), m = b.period, n = b.count, q = AmCharts
							.getPeriodDuration(m, n));
			var r = {};
			this.lookupTable = r;
			...
			for (t = 0; t < e.length; t++) {
				...
				r[u[d]] = s;
				if (f
						&& (b = h.categoryFunction ? h
								.categoryFunction(b, u, h) : b instanceof Date
								? AmCharts.newDate(b, h.minPeriod)
								: w ? AmCharts.stringToDate(b, w) : new Date(b), b = AmCharts
								.resetDateToMin(b, m, n, h.firstDayOfWeek), s.category = b, s.time = b
								.getTime(), isNaN(s.time)))
					continue;
				...
				for (F = 0; F < x.length; F++) {
					...
					for (z = 0; z < a.length; z++) {
						...
						if (b.valueAxis.id == B) {
							...
							!b.connect && v && v[I] && s.time - p[I] > 1.1 * q
									&& (v[I].gap = !0);
	...
	parseGraphData : function(a) {
		...
		for (d = 0; d < b.length; d++) {
			...
			f
					&& (g = f.axes[g].graphs[a.id], g.serialDataItem = f, g.values = this
							.processValues(e, a, a.periodValue), this
							.processFields(a, g, e))
		}
	},
	...
	processValueAxes : function() {
		var a = this.valueAxes, b;
		for (b = 0; b < a.length; b++) {
			var c = a[b], c = AmCharts.processObject(c, AmCharts.ValueAxis,
					this.theme);
			a[b] = c;
			c.chart = this;
	...
	processGuides : function() {
		...
		if (a)
			for (var c = 0; c < a.length; c++) {
				var d = a[c];
				(void 0 !== d.category || void 0 !== d.date) && b
						&& b.addGuide(d);
				var e = d.valueAxis;
				e ? (AmCharts.isString(e) && (e = this.getValueAxisById(e)), e
						? e.addGuide(d)
						: this.valueAxes[0].addGuide(d)) : isNaN(d.value)
						|| this.valueAxes[0].addGuide(d)
			}
	},
	processGraphs : function() {
		var a = this.graphs, b;
		for (b = 0; b < a.length; b++) {
			var c = a[b], c = AmCharts.processObject(c, AmCharts.AmGraph,
					this.theme);
			a[b] = c;
	...
	getBalloonColor : function(a, b, c) {
		...
		b.isNegative
				&& (c = a.negativeLineColor, a = a.negativeFillColors, "object" == typeof a
						? c = a[0]
						: void 0 !== a && (c = a), void 0 !== c && (d = c));
	...
	processFields : function(a, b, c) {
		...
		d = "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor dashLength pattern"
				.split(" ");
	...
	chooseGraphColor : function(a, b) {
		if (a.lineColor)
			...
			var c;
			c = this.colors.length > b ? this.colors[b] : AmCharts
					.randomColor();
			a.lineColorR = c
		}
		...
		a.bulletBorderColorR = a.bulletBorderColor
				? a.bulletBorderColor
				: a.useLineColorForBulletBorder ? a.lineColorR : a.bulletColor;
			...
			switch (b) {
				case "clickMarker" :
					this.textClickEnabled
							&& (d ? this.hideGraphsBalloon(a) : this
									.showGraphsBalloon(a));
					break;
				case "clickLabel" :
	...
	showGraph : function(a) {
		a.switchable
				&& (a.hidden = !1, this.dataChanged = !0, "xy" != this.type
						&& (this.marginsUpdated = !1), this.chartCreated
						&& this.initChart())
	},
	hideGraph : function(a) {
		a.switchable
				&& (this.dataChanged = !0, "xy" != this.type
						&& (this.marginsUpdated = !1), a.hidden = !0, this.chartCreated
						&& this.initChart())
	},
...
AmCharts.AmSlicedChart = AmCharts.Class({
	...
	initChart : function() {
		...
		this.dataChanged
				&& (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, this
						.setLegendData(this.chartData));
		this.drawChart()
	},
	handleLegendEvent : function(a) {
	...
	formatString : function(a, b, c) {
		a = AmCharts.formatValue(a, b, ["value"], this.nf, "",
	...
	startSlice : function(a) {
		...
		b
				&& 0 < c
				&& (0 < a.alpha && b.show(), b.translate(a.startX, a.startY), b
						.animate({
									opacity : 1,
									translate : "0,0"
								}, c, this.startEffect))
	...
	drawTicks : function() {
		...
		for (b = 0; b < a.length; b++) {
			var c = a[b];
			if (c.label) {
				var d = c.ty, d = AmCharts.line(this.container, [c.tx0, c.tx,
								c.tx2], [c.ty0, d, d], this.labelTickColor,
						this.labelTickAlpha);
				c.tick = d;
				c.wedge.push(d)
			}
	...
	initialStart : function() {
		...
		a.timeOuts.push(c);
		a.chartCreated ? a.pullSlices(!0) : (a.startSlices(), 0 < b
	...
	pullSlice : function(a, b, c) {
		...
		(c = a.wedge)
				&& (0 < d ? c.animate({
						...
						}, d, this.pullOutEffect) : c.translate(b * a.pullX, b
								* a.pullY));
		1 == b
	...
	parseData : function() {
		...
		if (void 0 !== b) {
			...
			for (e = b = 0; e < c; e++)
				f = a[e], f.percents = f.value / d * 100, f.percents < this.groupPercent
						&& b++;
			...
			for (e = 0; e < a.length; e++)
				c
						...
						: (g = this.colors[e], void 0 === g
								&& (g = AmCharts.randomColor())), void 0 === a[e].color
						&& (a[e].color = g);
			this.recalculatePercents()
		}
	},
	recalculatePercents : function() {
		...
		for (c = 0; c < a.length; c++)
			d = this.chartData[c], d.percents = !d.hidden && 0 < d.value ? 100
					* d.value / b : 0
	},
	...
	measureMaxLabel : function() {
		...
		for (c = 0; c < a.length; c++) {
			...
			f && (e = f(d, e));
			d = AmCharts.text(this.container, e, this.color, this.fontFamily,
					this.fontSize);
			e = d.getBBox().width;
			e > b && (b = e);
			d.remove()
...
AmCharts.AmRectangularChart = AmCharts.Class({
	...
	resetMargins : function() {
		...
		if ("serial" == this.type) {
			...
			for (b = 0; b < c.length; b++) {
				var d = c[b];
				d.ignoreAxisWidth
						|| (d.setOrientation(this.rotate), d.fixAxisPosition(), a[d.position] = !0)
			}
			(b = this.categoryAxis)
					&& !b.ignoreAxisWidth
	...
	measureMargins : function() {
		...
		for (l = 0; l < a.length; l++)
			b = this.getAxisBounds(a[l], g, k, h, b), g = Math.round(b.l), k = Math
					.round(b.r), h = Math.round(b.t), b = Math.round(b.b);
		if (a = this.categoryAxis)
			b = this.getAxisBounds(a, g, k, h, b), g = Math.round(b.l), k = Math
					.round(b.r), h = Math.round(b.t), b = Math.round(b.b);
		d.left && g < c && (this.marginLeft = Math.round(-g + c));
		d.right && k >= e - c && (this.marginRight = Math.round(k - e + c));
		d.top
				&& h < c + this.titleHeight
				&& (this.marginTop = Math.round(this.marginTop - h + c
						+ this.titleHeight));
		d.bottom
				&& b > f - c
				&& (this.marginBottom = Math.round(this.marginBottom + b - f
						+ c));
		this.initChart()
	},
	...
	drawZoomOutButton : function() {
		...
		var c = a.color, d = a.fontSize, e = a.zoomOutButtonImageSize, f = a.zoomOutButtonImage, g = AmCharts.lang.zoomOutText
				|| a.zoomOutText, h = a.zoomOutButtonColor, k = a.zoomOutButtonAlpha, l = a.zoomOutButtonFontSize, m = a.zoomOutButtonPadding;
		isNaN(l) || (d = l);
		(l = a.zoomOutButtonFontColor) && (c = l);
		var l = a.zoomOutButton, n;
		l
				&& (l.fontSize && (d = l.fontSize), l.color && (c = l.color), l.backgroundColor
						&& (h = l.backgroundColor), isNaN(l.backgroundAlpha)
						|| (a.zoomOutButtonRollOverAlpha = l.backgroundAlpha));
		var p = l = 0;
		void 0 !== a.pathToImages
				&& f
				&& (n = a.container.image(a.pathToImages + f, 0, 0, e, e), b
						.push(n), n = n.getBBox(), l = n.width + 5);
		void 0 !== g
				&& (c = AmCharts.text(a.container, g, c, a.fontFamily, d,
						"start"), d = c.getBBox(), p = n
						? n.height / 2 - 3
						: d.height / 2, c.translate(l, p), b.push(c));
		n = b.getBBox();
		c = 1;
		AmCharts.isModern || (c = 0);
		h = AmCharts.rect(a.container, n.width + 2 * m + 5, n.height + 2 * m
						- 2, h, 1, 1, h, c);
		h.setAttr("opacity", k);
		h.translate(-m, -m);
		b.push(h);
		...
		a.zbBG = h;
		n = h.getBBox();
		b.translate(a.marginLeftReal + a.plotAreaWidth - n.width + m,
				a.marginTopReal + m);
		b.hide();
	...
	drawPlotArea : function() {
		var a = this.dx, b = this.dy, c = this.marginLeftReal, d = this.marginTopReal, e = this.plotAreaWidth
				- 1, f = this.plotAreaHeight - 1, g = this.plotAreaFillColors, h = this.plotAreaFillAlphas, k = this.plotAreaBorderColor, l = this.plotAreaBorderAlpha;
		this.trendLinesSet.clipRect(c, d, e, f);
		"object" == typeof h && (h = h[0]);
		g = AmCharts.polygon(this.container, [0, e, e, 0, 0], [0, 0, f, f, 0],
				g, h, 1, k, l, this.plotAreaGradientAngle);
		g.translate(c + a, d + b);
		this.set.push(g);
		0 !== a
				&& 0 !== b
				&& (g = this.plotAreaFillColors, "object" == typeof g
						&& (g = g[0]), g = AmCharts.adjustLuminosity(g, -.15), e = AmCharts
						.polygon(this.container, [0, a, e + a, e, 0], [0, b, b,
										0, 0], g, h, 1, k, l), e.translate(c, d
								+ f), this.set.push(e), a = AmCharts.polygon(
						this.container, [0, 0, a, a, 0], [0, f, f + b, b, 0],
	...
	updateDxy : function() {
		...
		this.d3x = Math.round(this.columnSpacing3D
				* Math.cos(this.angle * Math.PI / 180));
	...
	updateChartCursor : function() {
		var a = this.chartCursor;
		a
				&& (a = AmCharts.processObject(a, AmCharts.ChartCursor,
						this.theme), this.addChartCursor(a), a.x = this.marginLeftReal, a.y = this.marginTopReal, a.width = this.plotAreaWidth
						- 1, a.height = this.plotAreaHeight - 1, a.chart = this)
	},
	processScrollbars : function() {
		var a = this.chartScrollbar;
		a
				&& (a = AmCharts.processObject(a, AmCharts.ChartScrollbar,
						this.theme), this.addChartScrollbar(a))
	},
	...
	zoomTrendLines : function() {
		...
		for (b = 0; b < a.length; b++) {
			...
			c.valueAxis.recalculateToPercents
					? c.set && c.set.hide()
					: (c.x = this.marginLeftReal + this.horizontalPosition, c.y = this.marginTopReal
							+ this.verticalPosition, c.draw())
		}
	},
	...
	updateChartScrollbar : function(a, b) {
		if (a) {
			...
			"top" == a.position ? b ? (a.y = c, a.x = d - e - h) : (a.y = c - e
					+ g - 1 - h, a.x = d + f) : b ? (a.y = c + g, a.x = d
					+ this.plotAreaWidth + f + h) : (a.y = c
					+ this.plotAreaHeight + h, a.x = this.marginLeftReal)
		}
	},
	showZB : function(a) {
		var b = this.zbSet;
...
AmCharts.TrendLine = AmCharts.Class({
	...
	draw : function() {
		var a = this;
		a.destroy();
		var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, q = a.valueAxisX, r = a.initialXValue, t = a.finalXValue, w = a.initialValue, v = a.finalValue, s = p.recalculateToPercents, u = b.dataDateFormat;
		h
				&& (k
						&& (k instanceof Date
								|| (k = u
										? AmCharts.stringToDate(k, u)
										: new Date(k)), a.initialDate = k, d = h
								.dateToCoordinate(k)), l
						&& (d = h.categoryToCoordinate(l)), m
						&& (m instanceof Date
								|| (m = u
										? AmCharts.stringToDate(m, u)
										: new Date(m)), a.finalDate = m, e = h
								.dateToCoordinate(m)), n
						&& (e = h.categoryToCoordinate(n)));
		q
				&& !s
				&& (isNaN(r) || (d = q.getCoordinate(r)), isNaN(t)
						|| (e = q.getCoordinate(t)));
		p
				&& !s
				&& (isNaN(w) || (f = p.getCoordinate(w)), isNaN(v)
						|| (g = p.getCoordinate(v)));
		isNaN(d)
				|| isNaN(e)
				|| isNaN(f)
				|| isNaN(f)
				|| (b.rotate ? (h = [f, g], e = [d, e]) : (h = [d, e], e = [f,
						g]), f = a.lineColor, d = AmCharts.line(c, h, e, f,
						a.lineAlpha, a.lineThickness, a.dashLength), g = h, k = e, n = h[1]
						- h[0], p = e[1] - e[0], 0 === n && (n = .01), 0 === p
						&& (p = .01), l = n / Math.abs(n), m = p / Math.abs(p), p = n
						* p
						/ Math.abs(n * p)
						* Math.sqrt(Math.pow(n, 2) + Math.pow(p, 2)), n = Math
						.asin(n / p), p = 90 * Math.PI / 180 - n, n = Math
						.abs(5 * Math.cos(p)), p = Math.abs(5 * Math.sin(p)), g
						.push(h[1] - l * p, h[0] - l * p), k.push(e[1] + m * n,
						e[0] + m * n), h = AmCharts
						.polygon(c, g, k, f, .005, 0), c = c.set([h, d]), c
						.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet
						.push(c), a.line = d, a.set = c, h.mouseup(function() {
							a.handleLineClick()
						}).mouseover(function() {
							a.handleLineOver()
						}).mouseout(function() {
...
AmCharts.bullet = function(a, b, c, d, e, f, g, h, k, l, m) {
	...
	switch (b) {
		case "round" :
			...
			break;
		case "square" :
			n = AmCharts.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2,
							c / 2, -c / 2, -c / 2], d, e, f, g, h, l - 180);
			break;
		case "rectangle" :
			n = AmCharts.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2,
							-c / 2], d, e, f, g, h, l - 180);
			break;
		case "diamond" :
			n = AmCharts.polygon(a, [-c / 2, 0, c / 2, 0],
					[0, -c / 2, 0, c / 2], d, e, f, g, h);
			break;
		case "triangleUp" :
		...
		case "yError" :
			...
			break;
		case "xError" :
			n = a.set(), n.push(AmCharts.line(a, [-c / 2, c / 2], [0, 0], d, e,
					f)), n.push(AmCharts.line(a, [-c / 2, -c / 2], [-k, k], d,
					e, f)), n.push(AmCharts.line(a, [c / 2, c / 2], [-k, k], d,
					e, f))
	}
	n && n.pattern(m);
	return n
...
AmCharts.makeHD = function(a, b, c) {
	for (var d = [], e = [], f = 1; f < a.length; f++)
		for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math
				.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math
				.round(m / 50)
				+ 1, k = (k - g) / m, l = (l - h) / m, n = 0; n <= m; n++) {
			var p = g + n * k + Math.random() * c, q = h + n * l
					+ Math.random() * c;
			d.push(p);
			e.push(q)
		}
...
AmCharts.handDrawnLine = function(a, b, c, d, e, f, g, h, k, l, m) {
	...
	for (m = 1; m < b.length; m++)
		for (var p = [b[m - 1], b[m]], q = [c[m - 1], c[m]], q = AmCharts
				.makeHD(p, q, a.handDrawScatter), p = q[0], q = q[1], r = 1; r < p.length; r++)
			n.push(AmCharts.line(a, [p[r - 1], p[r]], [q[r - 1], q[r]], d, e, f
							+ Math.random() * a.handDrawThickness
							- a.handDrawThickness / 2, g, h, k, l, !0));
	return n
};
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
	...
	359.94 < t && (t = 359.94);
	e >= t && (e = t);
	var w = 1 / 180 * Math.PI, t = b + Math.sin(d * w) * h, v = c
			- Math.cos(d * w) * q, s = b + Math.sin(d * w) * f, u = c
			- Math.cos(d * w) * g, x = b + Math.sin((d + e) * w) * f, F = c
			- Math.cos((d + e) * w) * g, B = b + Math.sin((d + e) * w) * h, w = c
			- Math.cos((d + e) * w) * q, z = {
	...
	var E;
	r
			&& (t = p(10 * t), s = p(10 * s), x = p(10 * x), B = p(10 * B), v = p(10
					* v), u = p(10 * u), F = p(10 * F), w = p(10 * w), b = p(10
					* b), k = p(10 * k), c = p(10 * c), f *= 10, g *= 10, h *= 10, q *= 10, 1 > Math
					.abs(e)
					&& 1 >= Math.abs(x - s) && 1 >= Math.abs(F - u) && (E = !0));
	e = "";
	var H;
	n
			&& (z["fill-opacity"] = 0, z["stroke-opacity"] = l["stroke-opacity"]
					/ 2, z.stroke = l.stroke);
	0 < k
			&& (H = " M" + t + "," + (v + k) + " L" + s + "," + (u + k), r
					? (E
					...
					: (H += " A" + f + "," + g + ",0," + I + ",1," + x + ","
							...
							&& (H += " A" + h + "," + q + ",0," + I + ",0," + t
									+ "," + (v + k))), H = a.path(H + " Z",
					void 0, void 0, "1000,1000").attr(z), d.push(H), H = a
					.path(
							" M" + t + "," + v + " L" + t + "," + (v + k)
									+ " L" + s + "," + (u + k) + " L" + s + ","
									+ u + " L" + t + "," + v + " Z", void 0,
							void 0, "1000,1000").attr(z), k = a.path(
					" M" + x + "," + F + " L" + x + "," + (F + k) + " L" + B
							+ "," + (w + k) + " L" + B + "," + w + " L" + x
							+ "," + F + " Z", void 0, void 0, "1000,1000")
					.attr(z), d.push(H), d.push(k));
	r ? (E
			|| (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + ","
					+ p(c + g) + "," + p(s) + "," + p(u) + "," + p(x) + ","
					+ p(F)), f = " M" + p(t) + "," + p(v) + " L" + p(s) + ","
			+ p(u) + e + " L" + p(B) + "," + p(w)) : f = " M" + t + "," + v
			+ " L" + s + "," + u
			+ (" A" + f + "," + g + ",0," + I + ",1," + x + "," + F) + " L" + B
			+ "," + w;
	0 < h
			&& (r ? E
					...
					+ t + "," + v);
	a.handDrawn
			&& (b = AmCharts.line(a, [t, s], [v, u], l.stroke, l.thickness
							* Math.random() * a.handDrawThickness,
					l["stroke-opacity"]), d.push(b));
...
AmCharts.adjustLuminosity = function(a, b) {
	...
	var c = "#", d, e;
	for (e = 0; 3 > e; e++)
		d = parseInt(a.substr(2 * e, 2), 16), d = Math.round(Math.min(Math.max(
						0, d + d * b), 255)).toString(16), c += ("00" + d)
				.substr(d.length);
	return c
};
AmCharts.Bezier = AmCharts.Class({
	...
	drawBezierMidpoint : function(a, b, c, d) {
		var e = Math.round, f = this.getPointOnSegment(a, b, .75), g = this
				.getPointOnSegment(d, c, .75), h = (d.x - a.x) / 16, k = (d.y - a.y)
				/ 16, l = this.getPointOnSegment(a, b, .375);
...
AmCharts.AmDraw = AmCharts.Class({
		...
		if (AmCharts.hasSVG) {
			...
			b
					.appendChild(document
							.createTextNode("JavaScript chart by amCharts "
									+ d.version));
			e.appendChild(b);
			AmCharts.rtl
					&& (e.setAttribute("direction", "rtl"), e.style.left = "auto", e.style.right = "0px");
			...
			AmCharts.isIE
					...
					&& (AmCharts.VML = !0, AmCharts.vmlStyleSheet
							|| (document.namespaces.add("amvml",
									"urn:schemas-microsoft-com:vml"), 31 > document.styleSheets.length
									? (e = document.createStyleSheet(), e
											.addRule(".amvml",
													"behavior:url(#default#VML); display:inline-block; antialias:true"), AmCharts.vmlStyleSheet = e)
									: document.styleSheets[0]
											.addRule(".amvml",
													"behavior:url(#default#VML); display:inline-block; antialias:true")), this.container = a, this.R = new AmCharts.VMLRenderer(
							this, d), this.R.disableSelection(a))
	},
	...
	rect : function(a, b, c, d, e, f, g) {
		...
		AmCharts.VML
				&& (e = Math.round(100 * e / Math.min(c, d)), c += 2 * f, d += 2
						* f, h.bw = f, h.node.style.marginLeft = -f, h.node.style.marginTop = -f);
		1 > c && (c = 1);
		1 > d && (d = 1);
		h.attr({
					x : a,
...
AmCharts.AmDObject = AmCharts.Class({
			...
			toPrevious : function() {
				var a = this.node;
				a && this.prevNextNode && (a = a.parentNode)
			...
			contextmenu : function(a) {
				this.node.addEventListener ? this.node.addEventListener(
						"contextmenu", a, !0) : this.R.addListener(this,
						"contextmenu", a);
				return this
			},
			stop : function(a) {
...
AmCharts.VMLRenderer = AmCharts.Class({
	...
	setAttr : function(a, b, c) {
		if (void 0 !== c) {
			...
			"text" == f
					&& ("text-anchor" == b
							&& (a.anchor = c, h = e.clientWidth, "end" == c
									&& (g.marginLeft = -h + "px"), "middle" == c
									&& (g.marginLeft = -(h / 2) + "px", g.textAlign = "center"), "start" == c
									&& (g.marginLeft = "0px")), "fill" == b
							&& (g.color = c), "font-weight" == b
							&& (g.fontWeight = c));
			if (g = a.children)
			...
			if ("shape" == f) {
				"cs" == b
						&& (e.style.width = "100px", e.style.height = "100px", e
								.setAttribute("coordsize", c));
				...
				"stroke-dasharray" == b
						&& (g = "solid", 0 < c && 3 > c && (g = "dot"), 3 <= c
								&& 6 >= c && (g = "dash"), 6 < c
								&& (g = "longdash"), d ? f.dashstyle = g : f
								.setAttribute("dashstyle", g));
				if ("fill-opacity" == b || "opacity" == b)
					0 === c ? d ? a.on = !1 : a.setAttribute("on", !1) : d
							? a.opacity = c
							: a.setAttribute("opacity", c);
				"fill" == b && (d ? a.color = c : a.setAttribute("color", c));
				"rx" == b
						&& (d ? e.arcSize = c + "%" : e.setAttribute("arcsize",
								c + "%"))
			}
		}
	},
	...
	move : function(a, b, c) {
		...
		"oval" == a.shapeType
				&& (b -= AmCharts.removePx(e.width) / 2, c -= AmCharts
						.removePx(e.height)
						/ 2);
		a = a.bw;
		isNaN(a) || (b -= a, c -= a);
	...
	svgPathToVml : function(a) {
		...
		for (e = 0; e < b.length; e++) {
			var f = b[e], g = f.substring(0, 1), f = f.substring(1), h = f
					.split(","), k = d(h[0]) + "," + d(h[1]);
			"M" == g && (a += " m " + k);
			"L" == g && (a += " l " + k);
			"Z" == g && (a += " x e");
	...
	clipRect : function(a, b, c, d, e) {
		a = a.node;
		0 === b && 0 === c ? (a.style.width = d + "px", a.style.height = e
				+ "px", a.style.overflow = "hidden") : a.style.clip = "rect("
				+ c + "px " + (b + d) + "px " + (c + e) + "px " + b + "px)"
	},
	rotate : function(a, b, c) {
		if (0 !== Number(b)) {
			...
			a.paddingLeft = 1;
			c = b * Math.PI / 180;
			var e = Math.cos(c), f = Math.sin(c), g = AmCharts.removePx(a.left), h = AmCharts
					.removePx(a.top), k = d.offsetWidth, d = d.offsetHeight;
			b /= Math.abs(b);
			a.left = g + k / 2 - k / 2 * Math.cos(c) - b * d / 2 * Math.sin(c)
					+ 3;
	...
	gradient : function(a, b, c, d) {
		...
		for (f = 0; f < c.length; f++) {
			var g = Math.round(100 * f / (c.length - 1)), e = e
					+ (g + "% " + c[f]);
			f < c.length - 1 && (e += ",")
		}
		a = a.fill;
		90 == d ? d = 0 : 270 == d ? d = 180 : 180 == d ? d = 90 : 0 === d
				&& (d = 270);
		8 === document.documentMode ? (a.type = b, a.angle = d) : (a
				.setAttribute("type", b), a.setAttribute("angle", d));
		e && (a.colors.value = e)
	},
	remove : function(a) {
	...
	pattern : function(a, b) {
		...
		b.color && (e = b.color);
		c.fillColor = e;
		8 === document.documentMode ? (d.type = "tile", d.src = b.url) : (d
				.setAttribute("type", "tile"), d.setAttribute("src", b.url))
	},
	update : function() {
	}
});
AmCharts.SVGRenderer = AmCharts.Class({
	...
	animate : function(a, b, c, d, e) {
		...
		a["an_" + b] && AmCharts.removeFromArray(this.animations, a["an_" + b]);
		"translate" == b
				? (f = (f = f.getAttribute("transform")) ? String(f).substring(
						10, f.length - 1) : "0,0", f = f.split(", ").join(" "), f = f
						.split(" ").join(","), 0 === f && (f = "0,0"))
	...
	update : function() {
		...
		for (a = b.length - 1; 0 <= a; a--) {
			var c = b[a], d = 1E3 * c.time / AmCharts.updateRate, e = c.frame
					+ 1, f = c.obj, g = c.attribute, h, k, l;
			e <= d
					? (c.frame++, "translate" == g
							? (h = c.from.split(","), g = Number(h[0]), h = Number(h[1]), isNaN(h)
									&& (h = 0), k = c.to.split(","), l = Number(k[0]), k = Number(k[1]), l = 0 === l
									- g ? l : Math.round(AmCharts[c.effect](0,
									e, g, l - g, d)), c = 0 === k - h
									? k
									: Math.round(AmCharts[c.effect](0, e, h, k
													- h, d)), g = "transform", c = "translate("
									+ l + "," + c + ")")
							: (k = Number(c.from), h = Number(c.to), l = h - k, c = AmCharts[c.effect](
									0, e, k, l, d), isNaN(c) && (c = h), 0 === l
									&& this.animations.splice(a, 1)), this
							.setAttr(f, g, c))
					: ("translate" == g
							? (k = c.to.split(","), l = Number(k[0]), k = Number(k[1]), f
									.translate(l, k))
							: (h = Number(c.to), this.setAttr(f, g, h)), this.animations
							.splice(a, 1))
		}
	},
	getBBox : function(a) {
	...
	clipRect : function(a, b, c, d, e) {
		...
		var h = f.parentNode;
		h
				&& (f = document.createElementNS(AmCharts.SVG_NS, "clipPath"), g = AmCharts
						.getUniqueId(), f.setAttribute("id", g), this.D.rect(b,
						c, d, e, 0, 0, f), h.appendChild(f), b = "#", AmCharts.baseHref
						&& !AmCharts.isIE
						&& (b = this.removeTarget(window.location.href) + b), this
	...
	setText : function(a, b) {
		var c = a.node;
		c
				&& (c.removeChild(c.firstChild), c.appendChild(document
						.createTextNode(b)))
	},
	...
	gradient : function(a, b, c, d) {
		...
		for (d = 0; d < c.length; d++)
			g = document.createElementNS(AmCharts.SVG_NS, "stop"), h = 100 * d
					/ (c.length - 1), 0 === d && (h = 0), g.setAttribute(
					"offset", h + "%"), g.setAttribute("stop-color", c[d]), b
					.appendChild(g);
	...
	pattern : function(a, b, c) {
		...
		var e = a.patternNode;
		e && this.D.remove(e);
		var e = document.createElementNS(AmCharts.SVG_NS, "pattern"), f = AmCharts
				.getUniqueId(), g = b;
		b.url && (g = b.url);
		...
		b.color
				&& (m = document.createElementNS(AmCharts.SVG_NS, "rect"), m
						.setAttributeNS(null, "height", h), m.setAttributeNS(
						null, "width", k), m.setAttributeNS(null, "fill",
						b.color), e.appendChild(m));
...
AmCharts.AmLegend = AmCharts.Class({
	...
	drawLegend : function() {
		...
		if ("right" == b || "left" == b)
			this.maxColumns = 1, this.autoMargins
		...
		var k;
		void 0 !== c ? k = AmCharts.toCoordinate(c, d) : "right" != b
				&& "left" != b && (k = a.realWidth);
		"outside" == b ? (k = f.offsetWidth, e = f.offsetHeight, f.clientHeight
				&& (k = f.clientWidth, e = f.clientHeight)) : (isNaN(k)
				|| (f.style.width = k + "px"), f.className = "amChartsLegend");
		this.divWidth = k;
		(b = this.container)
				? (b.container.innerHTML = "", f.appendChild(b.container), b
						.setSize(k, e))
		...
		this.titleWidth = 0;
		if (e = this.title)
			a = AmCharts.text(this.container, e, this.color, a.fontFamily,
					this.fontSize, "start", !0), a.translate(this.marginLeft,
					this.marginTop + this.verticalGap + this.ly + 1), a = a
					.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height
					+ 6;
	...
	arrangeEntries : function() {
		var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = h
				- c - b, p = 0, q = 0, r = this.container;
		...
		for (u = 0; u < v.length; u++) {
			...
			var E;
			this.equalWidths
					? E = f + x * (p + m + this.markerLabelGap)
					: (E = F, F = F + s.width + f + m);
			s.height > z && (z = s.height);
			E + s.width > n
					&& 0 < u
					&& 0 !== x
					&& (q++, x = 0, E = f, F = E + s.width + f + m, B = B + z
							+ l, z = 0);
			I.translate(E, B);
			x++;
			!isNaN(k) && x >= k && (x = 0, q++, B = B + z + l, z = 0);
			w.push(I)
		}
		s = w.getBBox();
		k = s.height + 2 * l - 1;
		"left" == a || "right" == a ? (h = s.width + 2 * f, g.style.width = h
				+ b + c + "px") : h = h - b - c - 1;
		c = AmCharts.polygon(this.container, [0, h, h, 0], [0, 0, k, k],
		...
		if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
			"center" == this.align
					? b = f + (h - s.width) / 2
					: "right" == this.align && (b = f + h - s.width);
		w.translate(b, l + 1);
	...
	createEntry : function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			var k = this.container, l = this.markerSize, m = 0, n = 0, p = l
					/ 2;
			if (this.useGraphSettings)
				if (m = a.type, this.switchType = void 0, "line" == m
						|| "step" == m || "smoothedLine" == m || "ohlc" == m)
					g = k.set(), a.hidden
							|| (d = a.lineColorR, f = a.bulletBorderColorR), n = AmCharts
							.line(k, [0, 2 * l], [l / 2, l / 2], d,
									a.lineAlpha, a.lineThickness, a.dashLength), g
							.push(n), a.bullet
							&& (a.hidden || (d = a.bulletColorR), n = AmCharts
									.bullet(k, a.bullet, a.bulletSize, d,
											a.bulletAlpha,
											a.bulletBorderThickness, f,
											a.bulletBorderAlpha))
							&& (n.translate(l + 1, l / 2), g.push(n)), p = 0, m = l, n = l
							/ 3;
				else {
					var q;
					...
					m = a.fillColorsR;
					!0 === a.hidden && (m = d);
					if (g = this.createMarker("rectangle", m, a.fillAlphas,
							a.lineThickness, d, a.lineAlpha, q, g))
						p = l, g.translate(p, l / 2);
					m = l
				}
			else
				h
						? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l,
								l))
						: (g = this.createMarker(c, d, e, void 0, void 0,
								void 0, void 0, g))
								&& g.translate(l / 2, l / 2);
			...
			(f = this.switchType)
					&& "none" != f
					&& ("x" == f ? (q = this.createX(), q.translate(l / 2, l
									/ 2)) : q = this.createV(), q.dItem = a, !0 !== a.hidden
							? "x" == f ? q.hide() : q.show()
							: "x" != f && q.hide(), this.switchable || q.hide(), this
							.addListeners(q, a), a.legendSwitch = q, k.push(q));
			f = this.color;
			...
			g
					&& (l <= q
							&& g.translate(p, l / 2 + this.ly - q / 2
											+ (q + 2 - l) / 2 - n), a.legendEntryWidth = g
							.getBBox().width);
			var r;
			d
					&& (d = AmCharts.fixBrakes(d), a.legendTextReal = d, r = this.labelWidth, r = isNaN(r)
							? AmCharts.text(this.container, d, f, b.fontFamily,
									q, "start")
							: AmCharts.wrappedText(this.container, d, f,
									b.fontFamily, q, "start", !1, r, 0), r
							.translate(this.lx + m, this.ly), k.push(r), b = r
							.getBBox().width, this.maxLabelWidth < b
	...
	clickMarker : function(a, b) {
		this.switchable
				&& (!0 === a.hidden ? this.dispatch("showItem", a, b) : this
	...
	createX : function() {
		var a = (this.markerSize - 4) / 2, b = {
			...
			"stroke-width" : 3
		}, c = this.container, d = AmCharts.line(c, [-a, a], [-a, a]).attr(b), a = AmCharts
				.line(c, [-a, a], [a, -a]).attr(b);
			...
			if (d)
				...
				if (void 0 !== f.type) {
					...
					h ? (g = this.valueText, f.legendValueText
							&& (g = f.legendValueText), g = b
							.formatString(g, h)) : k
							&& (g = b.formatPeriodString(k, f))
				} else
...
AmCharts.newDate = function(a, b) {
	return date = "fff" == b ? AmCharts.useUTC
			? new Date(a.getUTCFullYear(), a.getUTCMonth(), a.getUTCDate(), a
							.getUTCHours(), a.getUTCMinutes(), a
							.getUTCSeconds(), a.getUTCMilliseconds())
			: new Date(a.getFullYear(), a.getMonth(), a.getDate(),
					a.getHours(), a.getMinutes(), a.getSeconds(), a
							.getMilliseconds()) : new Date(a)
};
AmCharts.resetDateToMin = function(a, b, c, d) {
	void 0 === d && (d = 1);
	var e, f, g, h, k, l, m;
	AmCharts.useUTC
			? (e = a.getUTCFullYear(), f = a.getUTCMonth(), g = a.getUTCDate(), h = a
					.getUTCHours(), k = a.getUTCMinutes(), l = a
					.getUTCSeconds(), m = a.getUTCMilliseconds(), a = a
					.getUTCDay())
			: (e = a.getFullYear(), f = a.getMonth(), g = a.getDate(), h = a
					.getHours(), k = a.getMinutes(), l = a.getSeconds(), m = a
					.getMilliseconds(), a = a.getDay());
	switch (b) {
		case "YYYY" :
			e = Math.floor(e / c) * c;
			f = 0;
	...
	AmCharts.useUTC ? (a = new Date, a.setUTCFullYear(e, f, g), a.setUTCHours(
			h, k, l, m)) : a = new Date(e, f, g, h, k, l, m);
	return a
};
...
AmCharts.getMaxInterval = function(a, b) {
	...
	return a >= c[b].contains
			? (a = Math.round(a / c[b].contains), b = c[b].nextInterval, AmCharts
					.getMaxInterval(a, b))
			: "ss" == b ? c[b].nextInterval : b
};
...
AmCharts.stringToDate = function(a, b) {
	...
	AmCharts.useUTC
			? (d = new Date, d.setUTCFullYear(c.year, c.month, c.date), d
					.setUTCHours(c.hours, c.minutes, c.seconds, c.milliseconds))
			: d = new Date(c.year, c.month, c.date, c.hours, c.minutes,
					c.seconds, c.milliseconds);
	return d
};
AmCharts.getFromDateString = function(a, b, c) {
	if (void 0 !== b)
		return c = c.indexOf(a), b = b.substr(c, a.length), "0" == b.charAt(0)
				&& (b = b.substr(1, b.length - 1)), b = Number(b), isNaN(b)
				&& (b = 0), -1 != a.indexOf("M") && b--, b
};
AmCharts.formatDate = function(a, b, c) {
	...
	AmCharts.useUTC
			? (d = a.getUTCFullYear(), e = a.getUTCMonth(), f = a.getUTCDate(), g = a
					.getUTCDay(), h = a.getUTCHours(), k = a.getUTCMinutes(), l = a
					.getUTCSeconds(), a = a.getUTCMilliseconds())
			: (d = a.getFullYear(), e = a.getMonth(), f = a.getDate(), g = a
					.getDay(), h = a.getHours(), k = a.getMinutes(), l = a
					.getSeconds(), a = a.getMilliseconds());
