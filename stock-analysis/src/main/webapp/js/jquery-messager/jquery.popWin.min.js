...
$j.extend(fixed.prototype,{ie6:$.browser.msie&&$.browser.version<7.0,bindEvent:function(){var o=this;o.sts.target.css('position','absolute')
...
o.initBasePos();o.setPos()},1)}}})})(jQuery);(function($){$.fn.popWin=function(options){var def={PopSelector:"",CloseSelector:"",slideTime:600};var options=$.extend(def,options);var noie6=!($.browser.msie&&($.browser.version=="6.0")&&!$.support.style);var PopSelector=options.PopSelector,CloseSelector=options.CloseSelector,slideTime=options.slideTime;if(noie6){$(PopSelector).slideDown(slideTime)}
