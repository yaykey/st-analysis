...
function download_image (container) {
  ...
  graph = Flotr.draw(
    container,[ 
      {data:d1, label:'y = 4 + x^(1.5) d1', lines:{fill:true}}, 
      {data:d2, label:'y = x^3 d2', yaxis:2}, 
      {data:d3, label:'y = 5x + 3sin(4x) d3'}, 
      {data:d4, label:'y = x d4'},
      {data:d5, label:'y = 2x d5', lines: {show: true}, points: {show: true}},
      {data:d1, label:'y = 4 + x^(1.5) d1', lines:{fill:true}}, 
      {data:d2, label:'y = x^3 d2', yaxis:2}, 
      {data:d3, label:'y = 5x + 3sin(4x) d3'}, 
      {data:d4, label:'y = x d4'},
