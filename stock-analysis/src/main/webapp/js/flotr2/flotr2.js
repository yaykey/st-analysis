...
Graph.prototype = {
  ...
  calculateSpacing: function(){
    ...
    //----by yangzy
    var lp = options.legend.position;
    var lcol = options.legend.col || 1;
    
    if (lp.charAt(0) == 'b' || lp.charAt(1) == 'b' || lp.charAt(2) == 'b') {
    	//this.plotHeight -= 100;
    	//alert(Math.ceil(series.length/lcol));
    	this.plotHeight -= Math.ceil(series.length/lcol)*17 + 30;
    }
...
Flotr.addPlugin('legend', {
  options: {
    ...
    backgroundColor: '#000000', // => Legend background color.
  ...
  insertLegend: function(){
    ...
    if (itemCount) {
      ...
      if (!options.HtmlText && this.textEnabled && !legend.container) {
        ...
        //---by yangzy
        if (p.charAt(0) == 'b' || p.charAt(1) == 'b' || p.charAt(2) == 'b') {
        	offsetY += this.plotHeight + 40;
        }
       ...
       // var col = 1
        ...
        //---------by yangzy----------
        ctx.fillRect(offsetX, offsetY, legendWidth*col
        		, legendHeight/col + (series.length%col!=0?(lbh+10):0));
        
        ctx.strokeStyle = legend.labelBoxBorderColor;
        //---------by yangzy-----------
        ctx.strokeRect(Flotr.toPixel(offsetX), Flotr.toPixel(offsetY)
        		, legendWidth * col
        		, legendHeight/col + (series.length%col!=0?(lbh+10):0));
