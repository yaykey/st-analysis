		...
		$(document).ready(
			function(){
				...
				function hideToSearch(){
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getNearVisitChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
						"&province="+province_Ids+"&city="+city_Ids+"&dimId="+client_Ids+"&indexId="+dIndex_Ids+"&carrId="+operator_Ids+
