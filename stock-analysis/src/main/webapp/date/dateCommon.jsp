			...
			function(){
				...
				function hideToSearch(){
	               ...
	               /*  //日或小时的timeType都为1
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
