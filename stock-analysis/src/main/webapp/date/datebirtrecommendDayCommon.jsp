	...
	<script type="text/javascript">
		$(document).ready(
			function(){
					...
					success:function(msg){
						...
						for(var i=0; i<dateRange.length; i++){
							if(dateRange[i][0] == 1){
								...
								if(birtType==2||birtType==6||birtType==7||birtType==4||birtType==8||birtType==11||birtType==12||birtType==9||birtType==16){
				...
				/* Ajax取数据完毕  */
				if(birtType==2||birtType==6||birtType==7||birtType==4||birtType==8||birtType==9||birtType==11||birtType==12||birtType==15){
						var op = $('#rpt_day');
				...
				function calendar(val){
					if(val==1){
						...
						if(birtType==2||birtType==6||birtType==7||birtType==4||birtType==8||birtType==9||birtType==11||birtType==12||birtType==15||birtType==16){
							...
							$('#databirt').val(end_date + "-" +end_date);
							$('#databirt').DatePicker({
								format:'Ymd',
								date: new Date(),
								current: hourEnd,
						...
						$('#weekbirt').css('display', 'none');
						$('#monthbirt').val(end_date + "-" +end_date);
						...
						$('#databirt').css('display', 'none');
						$('#monthbirt').css('display', 'none');
						$('#weekbirt').css('display', 'inline');
						$('#weekbirt').val(weekRange);
