	...
	<script type="text/javascript">
		$(document).ready(
			function(){
				...
				/* Ajax取数据完毕  */
				var op = $("div .data_btn");
				calendar("data",$(op).attr("timetype"));
				calendar("data1",$(op).attr("timetype"));
				
				$("div[name='timetype']").bind('click', function(e){
					calendar("data",$(this).attr("timetype"));
					calendar("data1",$(this).attr("timetype"));
				});
