				...
				function hideToSearch(){
		          ...
		          //维度
		            ...
		            for(var i=0;i<clientIds.length;i++){
		            	var value=clientIds[i].value;
		            	dimId_dimTypeId +=value+",";
		            	var dimIds=value.split("_");
						client_Ids += dimIds[0]+",";
		           ...
		           //维度为空 页面提示
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getChartTwoDim.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1&dimAllZoneFlag=${dimAllZoneFlag}"+
