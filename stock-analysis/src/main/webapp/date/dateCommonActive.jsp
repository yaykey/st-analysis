		...
		$(document).ready(
			function(){
				...
				function hideToSearch(){
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getActiveChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
