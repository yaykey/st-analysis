			...
			function(){
				...
				function hideToSearch(){
		           ...
		           //维度为空 页面提示
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getChartZone.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
