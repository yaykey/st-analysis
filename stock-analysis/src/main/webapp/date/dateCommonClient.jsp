	...
	<script type="text/javascript">
		$(document).ready(
			...
			/* 		var operator_Ids = "";
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getDiscussChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
									"&province="+province_Ids+"&city="+city_Ids+"&carrId=${carrId}"+"&dimTypeId="+client_Types+"&dimId="+client_Ids+"&indexId="+dIndex_Ids+
