			...
			function hideToSearch(){
				...
				dimTypeIds= dimTypeIds.substring(0,dimTypeIds.length-1);
		           ...
		           jQuery.ajaxSetup({ cache: true });
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getCoreUserChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
