			...
			function(){
				...
				function hideToSearch(){
			        ...
			        if(dataTypeId==3){//说明二级维度多选
			         ...
			         }if(dataTypeId==1||dataTypeId==2||dataTypeId==5){//说明一级维度多选
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getAuditChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
									"&province="+province_Ids+"&city="+city_Ids+"&carrId=-1"+"&dimTypeId="+client_Types+"&dimId="+client_Ids+"&indexId="+strIndex+
