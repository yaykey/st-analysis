		...
		$(document).ready(
			function(){
				...
				function hideToSearch(){
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getDeskTopChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
						"&province="+province_Ids+"&city="+city_Ids+"&dimTypeId=${dimTypeId}&dimId=${dimId}&indexId="+dIndex_Ids+"&carrId="+operator_Ids+
						"&startTime="+startTime+"&endTime="+endTime+"&timeType="+timeType+"&dimTypeAndId=${dimTypeAndId}&queryType="+dataTypeId,
						dataType : 'text',
						data : {
