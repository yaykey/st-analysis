			...
			function(){
				...
				function hideToSearch(){
		           ...
		           //维度为空 页面提示
					...
					jQuery.ajax({
						type : "POST",
						url : base + "/report/amcharts/getCommunicationChart.feinno?vrtlId=${vrtlId}&tableName=${tableName}&acur=${acur}&dataType=${dataType}&xmlType=${xmlType}&widgetId=${widgetId}&functionId=${functionId}&refreshFlag=1"+
						"&queryType=1&province="+province_Ids+"&city="+city_Ids+"&carrId="+operator_Ids+"&dimTypeId="+secondLevelDimIds_Types+"&dimId="+secondLevelDimIds_Ids+"&indexId="+dIndex_Ids+
						"&startTime="+startTime+"&endTime="+endTime+"&timeType="+timeType+"&dimTypeAndId="+dimId_dimTypeId+"&oneLevelDimIds="+oneLevelDimIds[0].value,
						dataType : 'text',
						data : {
